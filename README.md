...
[![Website](https://img.shields.io/badge/website-crys-chen.github.io/ic-guide-blue)](https://crys-chen.github.io/ic-guide/)
[![License](https://img.shields.io/github/license/Crys-Chen/ic-guide)](https://github.com/Crys-Chen/ic-guide/blob/master/LICENSE)
[![Issues](https://img.shields.io/github/issues/Crys-Chen/ic-guide)](https://github.com/Crys-Chen/ic-guide/issues)
[![Stars](https://img.shields.io/github/stars/Crys-Chen/ic-guide)](https://github.com/Crys-Chen/ic-guide)
...
> 写作风格、内容尺度、价值取向等"软"性约束，详见站内 [参与建设](https://crys-chen.github.io/ic-guide/%E5%8F%82%E4%B8%8E%E5%BB%BA%E8%AE%BE/) 页。下面只讲"硬"性的——文件放哪、PR 怎么发。
...
如果你发现错误但不想/不会发 PR，[开一个 Issue](https://github.com/Crys-Chen/ic-guide/issues/new) 报告即可——一句话也行。
