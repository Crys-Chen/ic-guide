...
-   :material-book-open-variant: __[CS自学指南](https://csdiy.wiki/){target="_blank"}__

    北大 PKUFlyingPig 三年自学总结，**本站框架的来源**。覆盖 CS 几乎所有主干方向（系统 / 算法 / AI / 安全 / 图形学等），每门课均有质量评测与先修说明，按方向自取所需。

    - **规模** — GitHub 50k+ stars，国内学生人手一份
    - **内容** — 200+ 门 MIT / Stanford / CMU / UCB 精选课 + 工具链速通
    - **维护** — PKUFlyingPig + 社区 PR，MIT License 开源
    - **适用** — 想做 CS + 硬件交叉的同学，补 CS 主干方向的首选

-   :material-lifebuoy: __[上海交通大学生存手册](https://survivesjtu.gitbook.io/survivesjtumanual){target="_blank"}__

    2008 年交大学生共同撰写，2024 年持续更新。**不止交大适用**——凡是在体制内挣扎的工科生基本都能对号入座。批判制度而非个人，直接说清楚"游戏规则"。

    - **主题** — 选课 / 保研出国 / 实习就业 / 心态建设
    - **核心论断** — "国内绝大多数大学本科教学早已崩溃"——正视这个现实才能自救
    - **适用** — 尤其推荐大一新生入学前阅读
    - **贡献** — GitHub Fork + PR 开放，欢迎补充其他学校的经验

-   :material-rocket-launch: __[Agentic4Systems 暑期学校](https://www.llm4eda.org/){target="_blank"}__

    北大 / 中科院计算所 / 复旦 / 深圳河套联合主办的暑期集训，主题"用 AI 构建智算系统"。三条赛道：EDA 基础设施、智算芯片设计、AI 编译框架，四天内完成跨赛道的系统集成。

    - **主办** — 北大 · 中科院计算所 · 复旦 · 深圳河套学院
    - **门槛** — 微电子 / 计算机 / 信息类本研，有编程与系统开发基础
    - **产出** — 跨赛道智算系统集成；获奖现金 3000–10 万元 + 证书 + 实习推荐
    - **赛道** — EDA 基础设施 / 智算芯片设计 / AI 编译框架
