...
这个方向适合看到一条 I-V 曲线异常就想知道背后哪层物理出了问题、愿意在材料、器件、电路之间反复横跳的人。微电子本科有两个硬件切口，一个在器件侧，把固体物理、半导体物理学扎实，用 TCAD 把仿真和高压台实测对上；一个在电路侧，门极驱动和封装版图贴着纳秒开关和寄生电感做功率 IC，正是斯达半导、英诺赛科这类公司急缺的活。诚实说固体物理和功率电路都是硬门槛，节奏也慢，一颗器件常以季度甚至年计，舞台是 IEDM 和 ISPSD，更想做数字后端或纯算法的人多半不适合。
