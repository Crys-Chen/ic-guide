...
可jia'jia。它们性能虽好，比硅难伺候得多。碳化硅难的是把晶体长出来。它的单晶比硅难长太多，长晶里留下的位错和微管缺陷会直接吃掉一整片晶圆能用的器件数量，怎么把缺陷压下去、还压得便宜，是老生常谈的难题了。氮化镓也有自己的麻烦。快充和射频里的氮化镓是横向器件，电流贴着表面那薄薄一层走，耐压做到六百多伏就开始吃力，所以它只能守在中低压的高频场。想让氮化镓也进电动车那种几百上千伏、几百安的场合，就得把器件竖过来，让电流在材料里纵向穿过、靠厚度扛电压，高电场被推进体内，背面还能直接当散热的出口。但困难在于衬底，又大又便宜、缺陷又少的体氮化镓晶圆至今难得。？？？
...
- **GaN 的电流崩塌与散热**：缓冲层陷阱会让 GaN HEMT 在高压开关时电流远低于直流值，陷阱来源与外延抑制至今各执一词，再加上 GaN 自加热严重、热导率不如 SiC，得靠 GaN-on-SiC 甚至 GaN-on-diamond 抽热，到了 Ga₂O₃ 更成命门。
- **把禁带优势兑现成器件性能**：SiC/GaN 三倍于硅的禁带理论上给出更高击穿场强和更低导通电阻，实测却离物理上限总有距离，GaN 又靠几 MHz 高频把储能电感电容做小、却受损耗与 EMI 反噬，结构与边界都待厘清。
...
这个方向适合看到一条 I-V 曲线异常就想知道背后哪层物理出了问题、愿意在材料、器件、电路之间反复横跳的人。微电子本科有两个硬件切口，一个在器件侧，把固体物理、半导体物理学扎实，用 TCAD 把仿真和高压台实测对上；一个在电路侧，门极驱动和封装版图贴着纳秒开关和寄生电感协同设计，正是产业急缺的活。诚实说固体物理和功率电路都是硬门槛，节奏也慢，一颗器件常以季度甚至年计，舞台是 IEDM 和 ISPSD，更想做数字后端或纯算法的人多半不适合。
