...
- [中科院信息工程研究所（信工所）](http://www.iie.ac.cn/) — 处理器安全架构、侧信道防御、国产 CPU 安全
- [中国科学院软件研究所·可信计算与信息保障实验室](http://tca.iscas.ac.cn/) — 可信计算、密码工程
- [上海交大密码与计算机安全实验室（LoCCS）](https://loccs.sjtu.edu.cn/) — 密码工程与侧信道分析
