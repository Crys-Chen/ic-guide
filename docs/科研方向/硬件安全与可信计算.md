...
- 数字电路 / HDL → [电路（数字）](../学习地图/电路/数字设计/index.md)、[电路总览](../学习地图/电路/index.md)
- ASIC 设计流程 → [电路 · ASIC 设计](../学习地图/电路/数字设计/ASIC与数字后端/FDU_INFO130094.md)
- 体系结构 / 微架构 → [系统架构 · 体系结构](../学习地图/系统架构/体系结构/index.md)
- 操作系统 → [系统架构 · 操作系统](../学习地图/系统架构/操作系统/index.md)
- 密码学（含 MPC/FHE/ZKP 与加速器的数学底座）→ [数学进阶 · 密码学（Stanford）](../学习地图/数学/专题/密码学/Stanford_crypto.md)、[数学进阶](../学习地图/数学/index.md)
