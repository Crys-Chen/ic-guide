...
- [紫光国微](https://www.gosinoic.com/) · [实时股价](https://quote.eastmoney.com/sz002049.html) — 智能安全芯片/SIM 卡/金融 IC 卡安全
- [国芯科技（C\*Core）](https://www.china-core.com/) · [实时股价](https://quote.eastmoney.com/sh688262.html) — 自主嵌入式 CPU、云-边-端密码安全芯片
- [三未信安（Sansec）](https://www.sansec.com.cn/) · [实时股价](https://quote.eastmoney.com/sh688489.html) — 商用密码芯片/密码机、国密算法硬件实现
- [海光信息（Hygon）](https://www.hygon.cn/) · [实时股价](https://quote.eastmoney.com/sh688041.html) — CPU 内置安全处理器、可信计算与机密计算（CSV）
- [华控清交（Tsingj）](https://www.tsingj.com/)（安全多方计算 MPC 隐私计算平台，未上市）
- [华为](https://www.huawei.com/cn/)（海思安全芯片、TEE/可信执行环境，华为未上市）
- [Cysic](https://cysic.xyz/)（零知识证明 ZK 硬件加速，未上市）

**国外**

- [Arm](https://www.arm.com/) · [实时股价](https://finance.yahoo.com/quote/ARM) — TrustZone、CryptoCell 安全 IP
- [Rambus](https://www.rambus.com/security/) · [实时股价](https://finance.yahoo.com/quote/RMBS) — 硬件信任根、密码核安全 IP
- [Intel](https://www.intel.com/content/www/us/en/products/docs/accelerator-engines/software-guard-extensions.html) · [实时股价](https://finance.yahoo.com/quote/INTC) — SGX/TDX 可信执行环境、机密计算、FHE 加速器原型
- [IBM](https://www.ibm.com/security) · [实时股价](https://finance.yahoo.com/quote/IBM) — 安全协处理器、机密计算
- [Google](https://www.google.com/) · [实时股价](https://finance.yahoo.com/quote/GOOGL) — Titan 安全芯片、机密计算
- [PUFsecurity](https://www.pufsecurity.com/)（PUF 硬件信任根/身份认证 IP，母公司力旺电子）· [母公司股价](https://finance.yahoo.com/quote/3529.TWO)
- [PQShield](https://pqshield.com/)（后量子密码硬件 IP，牛津衍生，未上市）
- [Ingonyama](https://www.ingonyama.com/)（零知识证明 ZK 硬件加速，未上市）
- [Optalysys](https://optalysys.com/)（光学同态加密 FHE 加速器，英国，未上市）
- [Niobium](https://www.niobiummicrosystems.com/)（专用同态加密 FHE 加速芯片，未上市）

### 科研院所

**国内**

- [中科院信息工程研究所（信工所）](http://www.iie.ac.cn/) — 网络空间安全防御全国重点实验室、处理器安全架构与国产 CPU 安全
- [清华大学集成电路学院](https://www.sic.tsinghua.edu.cn/) — 可重构密码芯片、PUF/TRNG、后量子密码芯片
- [上海交大密码与计算机安全实验室（LoCCS）](https://loccs.sjtu.edu.cn/) — 密码工程、侧信道分析、密态计算

**国外**

- [MIT CSAIL](https://www.csail.mit.edu/) — 硅基 PUF、AEGIS 安全处理器（Devadas 组）
- [佛罗里达大学 FICS Research](https://fics.institute.ufl.edu/) — 硬件木马、IC 供应链安全
- [马普安全与隐私研究所（MPI-SP）](https://www.mpi-sp.org/) — 嵌入式安全、硬件逆向工程
- [TU Graz IAIK](https://www.iaik.tugraz.at/) — 微架构侧信道（Meltdown/Spectre 发现地之一）

## 顶会顶刊

**顶会**：HOST（硬件安全专属）· IEEE S&P（Oakland）· ACM CCS · USENIX Security · NDSS · DAC · CHES（密码硬件与嵌入式）

**顶刊**：IEEE TIFS（信息取证与安全）· IEEE TDSC（可信与安全计算）· IACR TCHES · IEEE TVLSI · ACM TODAES
