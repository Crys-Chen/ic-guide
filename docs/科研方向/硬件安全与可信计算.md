...
- [Intel](https://www.intel.com/content/www/us/en/security/hardware/hardware-security-overview.html) · [实时股价](https://finance.yahoo.com/quote/INTC) — SGX/TDX 可信执行环境、机密计算、FHE 加速器原型
