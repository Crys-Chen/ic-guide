...
hide:
  - navigation
---
用集成电路的工艺在芯片上造出会动的机械结构，把力、声、压强这些物理量翻译成电信号。手机里的加速度计、陀螺仪和麦克风都出自这里。
...
适合喜欢动手做实物的人。这个方向横跨力学和电学，梁的刚度、振动、阻尼这套力学，加上模拟电路的噪声分析，是别处用不上、这里天天用的本事。日常从仿真、超净间工艺到探针台测试走全流程，结构是悬空的，粘连和应力随时让一批片子报废，一圈下来常要几个月。这一行认的是真器件量出来的曲线，仿真图说服不了人，所以得坐得住长闭环；回报是亲手让一个微米级的机械结构真的动起来，这种成就感别处没有。
