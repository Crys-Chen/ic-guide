...
- **超声与射频声学换能器**：CMUT 靠气隙电容收发超声，PMUT 沉积压电材料、灵敏度更高、撑起了屏下指纹，FBAR/SAW 谐振器又把这套压电平台搬进射频滤波，换一种机制就换一套设计逻辑。
- **生物 MEMS 与柔性可穿戴**：硅不兼容生命体也不会弯曲，得换成 PDMS、水凝胶或可降解聚合物，让植入式神经接口、器官芯片和贴皮电子皮肤能与组织长期共存。
- **气体传感与谐振质量探测**：氧化物半导体气敏薄膜要在低功耗下识别痕量气体，纳米谐振鼓的 Q 要从 10⁵ 推到 10⁸ 才能在频率偏移里数清落上来的单个分子。
