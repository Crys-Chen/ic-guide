...
适合沉得住气、重经验的人。模拟电子线路和信号与系统是根基，觉得差分对和反馈环路优雅而不是折磨的人，适合走这条路。日常就是在 Cadence 里调尺寸、跑仿真、画版图，一轮轮逼近物理极限，然后等流片、回片测试，论文的分量压在实测数据上。这一行经验复利，越久越有优势，但成长曲线也慢，前几年最辛苦，想靠快速迭代和走捷径的人不太合适。
