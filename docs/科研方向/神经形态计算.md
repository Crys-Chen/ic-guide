...
| 姓名 | 单位 | 研究方向 |
|------|------|----------|
| [施路平](https://www.cbicr.tsinghua.edu.cn/en/) | 清华大学类脑计算研究中心 | 天机（Tianjic）混合神经形态芯片主导者（Nature 2019 封面），SNN/ANN 融合架构 |
| [吴华强](http://stor.ime.tsinghua.edu.cn/dt_team/huaqiang-wu/) | 清华大学集成电路学院（IEEE Fellow 2026，杰青） | 忆阻器件与存内计算芯片；Science 2023 片上学习忆阻器芯片，器件到系统全栈 |
| [张悠慧](https://craft.cs.tsinghua.edu.cn/) | 清华大学计算机系 | 神经形态计算的编译器、运行时框架与系统架构 |
| [裴京](https://www.cbicr.tsinghua.edu.cn/centre_teacher/) | 清华大学精密仪器系 / CBICR | 天机芯片架构设计，同时支持 ANN 和 SNN 两种计算范式 |
...
| [刘琦](https://icmne.fudan.edu.cn/2d/2a/c48925a732458.htm) | 复旦大学集成电路与微纳电子创新学院（杰青） | ReRAM/FeRAM 与类脑计算芯片、SNN 无监督学习，发表于 Nature Commun./ISSCC/IEDM |
