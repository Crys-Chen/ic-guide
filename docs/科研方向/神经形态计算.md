...
| 姓名 | 单位 | 主页 | 研究方向 |
|------|------|------|----------|
| [施路平](https://www.cbicr.tsinghua.edu.cn/en/) | 清华大学类脑计算研究中心 | CBICR | 天机（Tianjic）混合神经形态芯片主导者（Nature 2019 封面），SNN/ANN 融合架构 |
| [吴华强](http://stor.ime.tsinghua.edu.cn/dt_team/huaqiang-wu/) | 清华大学集成电路学院（IEEE Fellow 2026，杰青） | LEMON Lab | 忆阻器件与存内计算芯片；Science 2023 片上学习忆阻器芯片，器件到系统全栈 |
| [张悠慧](https://craft.cs.tsinghua.edu.cn/) | 清华大学计算机系 | CRAFT Lab | 神经形态计算的编译器、运行时框架与系统架构 |
| [裴京](https://www.cbicr.tsinghua.edu.cn/centre_teacher/) | 清华大学精密仪器系 / CBICR | CBICR 师资页 | 天机芯片架构设计，同时支持 ANN 和 SNN 两种计算范式 |
| [唐建石](https://www.ime.tsinghua.edu.cn/info/1035/1595.htm) | 清华大学集成电路学院（国家海外高层次人才，MIT TR35） | 个人主页 | 忆阻器突触/神经元、储备池计算（SNN via memristor），发表于 Nature Electronics |
| [陈虹](https://www.sic.tsinghua.edu.cn/info/1014/1827.htm) | 清华大学集成电路学院（国家领军人才） | 个人主页 | 中国首款在线学习异步神经形态处理器、超低功耗神经形态芯片设计 |

**国内——北京大学**

| 姓名 | 单位 | 主页 | 研究方向 |
|------|------|------|----------|
| [黄如](https://ic.pku.edu.cn/szdw/ysfc/hr/index.htm) | 北京大学集成电路学院（中科院院士） | PKU 院士页 | GAA 器件、铁电存储器、**神经形态器件**、低功耗 IoT 芯片；先进突触器件与类脑系统，成果纳入 ITRS/IRDS |
| [杨玉超](http://yuchaolab.cn/) | 北京大学信息工程学院（杰青，新基石研究员 2025） | Yuchao Lab | 忆阻器 AI 硬件、神经形态计算（SNN、突触/神经元器件），发表 Nature Electronics/Nat. Rev. Mater. 等 20+ 篇 Nature 系列 |
| [蔡一茂](https://ic.pku.edu.cn/en/Faculty/Facultys/DepartmentofMicroNanoelectronics/CaiYimao/index.htm) | 北京大学集成电路学院（博雅特聘教授） | PKU 教师页 | RRAM 忆阻器件与神经形态计算，入选中国十大芯片进展（2023） |

**国内——复旦大学**

| 姓名 | 单位 | 主页 | 研究方向 |
|------|------|------|----------|
| [张续猛](https://icmne.fudan.edu.cn/2d/5e/c48925a732510/page.htm) | 复旦大学集成电路与微纳电子创新学院 | ICMNE 教师页 | 忆阻器神经元电路与脉冲类脑芯片，发表于 Nature Materials/Nat. Commun.，引用 6000+ |
| [周鹏](https://sme.fudan.edu.cn/60/68/c31158a352360/page.htm) | 复旦大学微电子学院 | 复旦教师页 | 二维半导体"感存算全在一"单器件仿视网膜集成（Nat. Nanotech. 2021）、视觉假体（Science 2025） |
| [刘琦](https://icmne.fudan.edu.cn/2d/2a/c48925a732458.htm) | 复旦大学集成电路与微纳电子创新学院（杰青） | ICMNE 教师页 | ReRAM/FeRAM 与类脑计算芯片、SNN 无监督学习，发表于 Nature Commun./ISSCC/IEDM |

**国际**

| 姓名 | 单位 | 主页 | 研究方向 |
|------|------|------|----------|
| [Kwabena Boahen](https://web.stanford.edu/group/brainsinsilicon/) | Stanford EE | Brains in Silicon | 反向工程大脑计算原理，研制 Neurogrid 类脑芯片 |
| [Shimeng Yu](https://shimeng.ece.gatech.edu/) | Georgia Tech ECE | Yu Lab | 新型存储器件与 CIM 架构（NeuroSim 工具开发者） |
| [Kaushik Roy](https://engineering.purdue.edu/NRL) | Purdue ECE | NRL | 神经形态计算与节能深度学习，器件/电路/算法协同设计 |
