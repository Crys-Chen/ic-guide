...
判断自己适不适合，先看课表。量子力学、固体物理、半导体物理这条线学得顺，甚至觉得能带图比电路图亲切，是最硬的信号。反过来，要是乐趣在写代码、搭系统、看快速反馈，这里会憋得慌。日常有两种过法。动手派泡在超净间和探针台之间，穿无尘服、长薄膜、做器件、量 I-V 和耐久性，一轮工艺几周起步，设备排队和片子报废是家常便饭。仿真派不进超净间，用 TCAD 跑器件、写统计模型啃 RRAM 的变异性，但同样要对着一个机制反复抠几个月。性格上它挑两种品质。一是对物理机制刨根问底的执念，看到 DIBL 会想追到漏极电场怎么把势垒拉低，看到阻变会追到氧空位细丝那一层才罢休。二是耐得住慢，这一行成果以年计，在 IEDM 上一年发一篇已算高产，它奖励把一个机制挖穿，不奖励快速迭代。如果你享受"原本的物理走到尽头，换一种物理顶上去"这种从根上解决问题的快感，这里是工程学科里离物理最近的位置。
