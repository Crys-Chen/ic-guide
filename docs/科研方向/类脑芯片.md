...
- [灵汐科技（Lynxi）](https://www.lynxi.com)（清华天机芯商业化，领启 KA200 类脑芯片，未上市）
- [时识科技（SynSense）](https://www.synsense.ai)（Speck/Xylo 超低功耗 SNN 芯片，未上市）
- [锐思智芯（Alpsentek）](https://www.alpsentek.com)（融合式仿生事件视觉传感器 ALPIX，事件驱动 DVS，未上市）
- [华为](https://www.huawei.com/cn/)（达芬奇架构 NPU · 类脑与存算探索，未上市）

**国外**

- [Intel](https://www.intel.com/content/www/us/en/research/neuromorphic-computing.html) · [实时股价](https://finance.yahoo.com/quote/INTC)（Loihi 2 神经形态芯片 · Lava 框架）
- [IBM](https://research.ibm.com/) · [实时股价](https://finance.yahoo.com/quote/IBM)（TrueNorth · NorthPole 类脑芯片）
- [BrainChip](https://brainchip.com) · [实时股价](https://finance.yahoo.com/quote/BRN.AX)（Akida 事件驱动边缘 AI 处理器，澳交所 ASX:BRN）
- [Prophesee](https://www.prophesee.ai)（Metavision 事件相机 · 仿视网膜神经形态视觉传感器，未上市）
- [Qualcomm](https://www.qualcomm.com) · [实时股价](https://finance.yahoo.com/quote/QCOM)（事件驱动感知 · 低功耗边缘 AI）

### 科研院所

**国内**

- [中科院微电子研究所](https://www.ime.ac.cn) — 忆阻器/自旋神经形态器件 · 存内类脑计算架构
- [中科院自动化研究所](https://www.ia.cas.cn) — 脑图谱与类脑智能 · 脉冲神经网络算法
- [之江实验室](https://www.zhejianglab.org) — 类脑计算与智能感知 · 神经形态计算系统

**国外**

- [University of Manchester（SpiNNaker）](https://apt.cs.manchester.ac.uk/projects/SpiNNaker/) — 百万核脉冲神经网络众核架构
- [imec](https://www.imec-int.com) — 神经形态器件与存算一体工艺平台（PREVAIL）
- [Fraunhofer IPMS](https://www.ipms.fraunhofer.de/en/Strategic-Research-Areas/Neuromorphic-Computing.html) — FeFET 交叉阵列 · 神经形态硬件
- [Intel Labs](https://www.intel.com/content/www/us/en/research/neuromorphic-computing.html) — Loihi 神经形态研究社区（INRC）

## 顶会顶刊

**顶会**：ISSCC · IEDM · VLSI Symposium（器件/电路）· NeurIPS · ICLR · AAAI（SNN 算法）· DAC

**顶刊**：Nature / Nature Electronics / Nature Machine Intelligence（旗舰成果）· JSSC（IEEE J. Solid-State Circuits）· TED（IEEE Trans. Electron Devices）· TNNLS（IEEE Trans. Neural Networks and Learning Systems）
