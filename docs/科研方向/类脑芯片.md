...
| 地区 | 公司 | 上市 / 股价 |
|---|---|---|
| 国内 | [灵汐科技（Lynxi）](https://www.lynxi.com) | <span class="sq-none">未上市</span> |
| 国内 | [时识科技（SynSense）](https://www.synsense.ai) | <span class="sq-none">未上市</span> |
| 国内 | [锐思智芯（Alpsentek）](https://www.alpsentek.com) | <span class="sq-none">未上市</span> |
| 国内 | [华为](https://www.huawei.com/cn/) | <span class="sq-none">未上市</span> |
| 国外 | [Intel](https://www.intel.com/content/www/us/en/research/neuromorphic-computing.html) | <span class="sq" data-stock="us:INTC"></span> |
| 国外 | [IBM](https://research.ibm.com/) | <span class="sq" data-stock="us:IBM"></span> |
| 国外 | [BrainChip](https://brainchip.com) | <a class="sq-na-link" href="https://finance.yahoo.com/quote/BRN.AX" target="_blank" rel="noopener">行情↗</a> |
| 国外 | [Prophesee](https://www.prophesee.ai) | <span class="sq-none">未上市</span> |
...
| 地区 | 机构 | 研究重点 |
|---|---|---|
| 国内 | [中科院微电子研究所](https://www.ime.ac.cn) | 忆阻器/自旋神经形态器件 · 存内类脑计算架构 |
| 国内 | [中科院自动化研究所](https://www.ia.cas.cn) | 脑图谱与类脑智能 · 脉冲神经网络算法 |
| 国内 | [之江实验室](https://www.zhejianglab.org) | 类脑计算与智能感知 · 神经形态计算系统 |
| 国外 | [University of Manchester（SpiNNaker）](https://apt.cs.manchester.ac.uk/projects/SpiNNaker/) | 百万核脉冲神经网络众核架构 |
| 国外 | [imec](https://www.imec-int.com) | 神经形态器件与存算一体工艺平台（PREVAIL） |
| 国外 | [Fraunhofer IPMS](https://www.ipms.fraunhofer.de/en/Strategic-Research-Areas/Neuromorphic-Computing.html) | FeFET 交叉阵列 · 神经形态硬件 |
| 国外 | [Intel Labs](https://www.intel.com/content/www/us/en/research/neuromorphic-computing.html) | Loihi 神经形态研究社区（INRC） |

## 顶会顶刊

| 类型 | 名称 | 说明 |
|---|---|---|
| 顶会 | ISSCC | 国际固态电路会议（器件/电路） |
| 顶会 | IEDM | 国际电子器件会议（器件/电路） |
| 顶会 | VLSI Symposium | VLSI 技术与电路研讨会（器件/电路） |
| 顶会 | NeurIPS | 神经信息处理系统大会（SNN 算法） |
| 顶会 | ICLR | 国际学习表征会议（SNN 算法） |
| 顶会 | AAAI | AAAI 人工智能大会（SNN 算法） |
| 顶会 | DAC | 设计自动化会议 |
| 顶刊 | Nature / Nature Electronics / Nature Machine Intelligence | 旗舰成果 |
| 顶刊 | JSSC | IEEE J. Solid-State Circuits |
| 顶刊 | TED | IEEE Trans. Electron Devices |
| 顶刊 | TNNLS | IEEE Trans. Neural Networks and Learning Systems |
