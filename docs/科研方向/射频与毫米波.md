...
| [闫娜](https://sme.fudan.edu.cn/60/61/c31157a352353/page.htm) | 复旦大学微电子学院（院长，2024 年国家级领军人才） | 高能效射频芯片与系统（6G 宽带可重构 RF、低温量子电路、IoT 超低功耗、毫米波雷达）、模数转换器、电源管理 |
| [徐鸿涛](https://sme.fudan.edu.cn/60/92/c31155a352402/page.htm) | 复旦大学微电子学院 | 毫米波 IC 与系统（智能传感器、5G/6G）、可穿戴 IoT 无线 SoC；50+ 论文，12 项美国专利，联合创办硅芯传奇微 |
...
| [俞捷（C. Patrick Yue）](https://ece.hkust.edu.hk/eepatrick) | 香港科技大学电子与计算机工程系（IEEE Fellow，OSA/Optica Fellow） | 毫米波通信与感知电路、光无线物理层、高速有线 SoC；Atheros Communications（首款 IEEE 802.11a CMOS Wi-Fi SoC）联合创始人 |
| [杨延松（Yansong Yang）](https://www.yansongyang.com/) | 香港科技大学电子与计算机工程系 | 压电 MEMS 谐振器与滤波器、5G/mmWave 射频前端；IEEE EDS Early Career Award 2023，IMS 2018 Best Paper |
...
| [Thomas Lee](https://profiles.stanford.edu/thomas-lee) | Stanford EE | 射频集成电路、超宽带/毫米波 CMOS、经典教材 *The Design of CMOS Radio-Frequency Integrated Circuits* 作者 |
| [Gabriel Rebeiz](https://jacobsschool.ucsd.edu/faculty/profile?id=238) | UCSD ECE | 相控阵与波束赋形、毫米波 RFIC、MEMS 开关，5G 毫米波先驱 |
