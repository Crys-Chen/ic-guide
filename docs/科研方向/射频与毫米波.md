...
| 姓名 | 单位 | 主页 | 研究方向 |
|------|------|------|----------|
| [王志华](https://www.sic.tsinghua.edu.cn/info/1014/1791.htm) | 清华大学集成电路学院（IEEE Fellow） | 个人主页 | 射频/混合信号 IC 与 RFID 芯片（主导国家标准制定）、高速高精度 ADC |
| [李宇根（Woogeun Rhee）](https://www.sic.tsinghua.edu.cn/info/1014/1809.htm) | 清华大学集成电路学院（IEEE Fellow） | 个人主页 | PLL/频率综合器、射频混合信号 IC、毫米波时钟系统 |
| [陈文华](https://web.ee.tsinghua.edu.cn/chenwenhua/zh_CN/index.htm) | 清华大学电子工程系（杰青） | 个人主页 | 射频功率放大器（PA）效率优化、5G/6G 线性化技术、Doherty PA |
| [邓伟](https://www.sic.tsinghua.edu.cn/info/1014/1823.htm) | 清华大学集成电路学院（IEEE SSCS Distinguished Lecturer） | 个人主页 | 高效率毫米波 PA 设计，前 Apple 首席芯片工程师 |
| [池保勇](https://www.sic.tsinghua.edu.cn/info/1014/1825.htm) | 清华大学集成电路学院 | 个人主页 | CMOS 毫米波收发机、5G 射频前端；ISSCC 发表论文 16 篇（国内学者之最） |
| [贾海昆](https://www.sic.tsinghua.edu.cn/info/1014/1815.htm) | 清华大学集成电路学院 | 个人主页 | 太赫兹（THz）CMOS 收发机、毫米波雷达 IC |
| [姜汉钧](https://www.sic.tsinghua.edu.cn/info/1014/1814.htm) | 清华大学集成电路学院 | 个人主页 | 低功耗无线神经记录芯片、高精度 ADC、IoT 混合信号 IC |
| [叶乐](https://ic.pku.edu.cn/szdw/zzjs/jcdlsjx1/yl/index.htm) | 北京大学集成电路学院（杰青） | PKU 教师页 | 混合信号与射频 IC、存算一体 AI 芯片；ISSCC 2021 年度最佳芯片奖 |
| [王茂俊](https://ic.pku.edu.cn/szdw/zzjs/jcwndzx1/wmj/index.htm) | 北京大学集成电路学院 | PKU 教师页 | GaN 功率与射频器件、高功率密度毫米波前端 |
| [洪志良](http://icmne.fudan.edu.cn) | 复旦大学微电子学院 | ICMNE Lab | 高性能模拟/混合信号 IC、射频收发机、高速接口芯片 |
| [汤章文](http://rfic.fudan.edu.cn) | 复旦大学微电子学院 | RFIC Lab | 毫米波 CMOS 收发机、相控阵芯片、5G/6G 射频前端 |
| [闵昊](http://rficae.fudan.edu.cn) | 复旦大学微电子学院 | RFIC-AE Lab | 射频与天线协同设计、毫米波封装天线（AiP）、相控阵系统 |
| [王志功](http://iroi.seu.edu.cn) | 东南大学 | IROI Lab | 微波光子集成电路、太赫兹器件、高速无线通信芯片 |

**国际**

| 姓名 | 单位 | 主页 | 研究方向 |
|------|------|------|----------|
| [Ali Niknejad](https://rfic.eecs.berkeley.edu) | UC Berkeley EECS | RFIC Group | 毫米波 CMOS 电路、5G/6G 收发机、BWRC 联合主任 |
| [Behzad Razavi](https://www.seas.ucla.edu/brweb/) | UCLA EE | Razavi Group | 射频/混合信号 IC 权威，教材作者（*RF Microelectronics*），VCO/PLL/LNA 设计 |
| [Thomas Lee](https://smirc.stanford.edu) | Stanford EE | SMIRC Lab | 射频集成电路、超宽带/毫米波 CMOS、经典教材 *The Design of CMOS Radio-Frequency Integrated Circuits* 作者 |
| [Gabriel Rebeiz](https://rebeizgroup.ucsd.edu) | UCSD ECE | Rebeiz Group | 相控阵与波束赋形、毫米波 RFIC、MEMS 开关，5G 毫米波先驱 |
| [Harish Krishnaswamy](https://cosmiccolumbia.com) | Columbia EE | CoSMIC Lab | 毫米波全双工、太赫兹 CMOS 收发机、频谱共享射频系统 |
