...
| 姓名 | 单位 | 主页 | 研究方向 |
|------|------|------|----------|
| [吴华强](https://stor.ime.tsinghua.edu.cn) | 清华大学集成电路学院 | STOR Lab | RRAM/MRAM 新型存储器、基于忆阻器的存算一体芯片 |
| [钱鹤](https://sic.tsinghua.edu.cn) | 清华大学集成电路学院 | SiC Lab | SRAM-CIM 存算一体电路、AI 推理芯片低功耗设计 |
| [刘明](https://fics.fudan.edu.cn/36/80/c22618a276096.htm) | 复旦大学芯片与系统前沿技术研究院（中科院院士，IEEE Fellow，院长） | FICS 主页 | 新型非易失存储器（Flash、RRAM）、存储器件物理与集成，国内存储器方向最权威学者之一 |
| [黄鹏](https://ic.pku.edu.cn/szdw/zzjs/sjzdhyjsxtx1/hp/index.htm) | 北京大学集成电路学院（国优青） | PKU 教师页 | RRAM 存算一体芯片与架构、传感-存储-计算融合系统，发表于 Nature Electronics/IEDM |
| [蔡一茂](https://ic.pku.edu.cn/en/Faculty/Facultys/DepartmentofMicroNanoelectronics/CaiYimao/index.htm) | 北京大学集成电路学院（博雅特聘教授） | PKU 教师页 | RRAM 新型存储器、忆阻器件、神经形态计算，入选中国十大芯片进展（2023） |
| [孙仲](http://scholar.pku.edu.cn/zhong_sun/home) | 北京大学人工智能研究院 | PKU 学者页 | 基于 RRAM 的高精度模拟矩阵计算芯片（Nature Electronics），存算一体综述 |
| [刘琦](https://icmne.fudan.edu.cn/2d/2a/c48925a732458.htm) | 复旦大学集成电路与微纳电子创新学院（国家杰青） | ICMNE 教师页 | ReRAM/FeRAM 新型存储器、忆阻神经形态器件、存算一体芯片，发表于 Nature Electronics/ISSCC/IEDM |
