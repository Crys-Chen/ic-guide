...
适合想做硬件但等不起流片的人。一个架构改动几小时就能上板看到结果，一块几百块的开发板就能开工，本科生攒第一段硬件科研经历，常常就从这里起步。数字逻辑和 Verilog 过关就能进场，想往工具侧走再补算法，布局布线本质是组合优化。日常围着板子转，写 RTL、等综合布线、上板抓波形。要认清 FPGA 比 ASIC 慢四倍、大三十倍，它的价值在灵活和低延迟，拿它拼峰值算力是走错了考场。
