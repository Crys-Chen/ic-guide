...
- **毫米波路径损耗、相控阵与频率天花板**：路径损耗约与频率平方成正比，28 GHz 比 2.4 GHz 同距离多衰减约 20 dB，只能把上百个天线单元和移相器塞进指甲盖大小的模组拧出波束抢回能量，再往上的太赫兹（300 GHz 以上）因晶体管增益枯竭、找不到趁手的有源器件而几近空白。
...
这个方向适合愿意把电磁场当第一性约束、对高频物理上心的人，习惯一根几毫米走线在毫米波变成天线、用 S 参数而非电压增益描述放大器。微电子本科最对口的硬件切口是模拟电路加电磁场，吃透噪声、差分对、偏置才谈得上拿捏 LNA 和 PA，正是国产替代最缺人的一环。诚实说节奏被流片死死拽住，一轮反馈常以半年计，舞台是 ISSCC 和 IMS，受不了慢的人要想清楚。
