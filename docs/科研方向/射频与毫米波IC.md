...
适合精打细算的人。这一行的思维方式是记账，高频路线算链路预算，每个 dB 的来去都要有交代；低功耗路线算能量预算，每个比特的能耗都要严格核算。课程上模拟电路是基础，真正的分水岭在电磁场，觉得史密斯圆图和 S 参数顺手才算入门。日常一半在仿真里优化电路和走线，一半在测试间操作网络分析仪、频谱仪，毫米波的测量本身就是一门专门的技术。流片半年一轮，仿真和实测对不上是常态，得有排查到底的韧性。
