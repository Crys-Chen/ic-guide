...
这个方向适合愿意把电磁场当第一性约束、对高频物理上心的人，习惯一根几毫米走线在毫米波变成天线，喜欢拿 S 参数而非电压增益描述放大器。微电子本科最对口的硬件切口是模拟电路加电磁场，吃透噪声、差分对、偏置，就能上手 LNA、PA、相控阵前端或低功耗收发机，这正是国产替代最缺人、卓胜微和唯捷创芯这类射频前端公司最想要的一环。诚实说节奏被流片死死拽住，一轮反馈常以半年计，舞台是 ISSCC，受不了慢的人要想清楚。
