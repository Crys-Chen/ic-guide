...
设计让无线信号穿越空间的模拟芯片，一端是追求带宽的毫米波，一端是追求能效的低功耗无线。
...
信号一旦离开天线，损耗就开始了。电磁波在空间中扩散，能量衰减很快，而且频率越高，衰减越严重。路径损耗大致与频率的平方成正比，28 GHz 的信号比 2.4 GHz 的在相同距离上多损耗约 20 dB，功率只剩百分之一。这正是链路预算最难平衡的地方，两侧给出了相反的答案。“快”这一侧迎难而上。与其用一根天线向四周辐射，不如把几十上百个微小的天线单元排成阵列，分别控制每个单元的相位，让电磁波在目标方向上叠加、在其他方向上抵消，汇聚成一束波束，把损失的能量补回来，这就是相控阵。手机直连卫星是它的极端例子：卫星相当于把基站搬到几百公里高的轨道上，靠星上一面很大的相控阵，对准地面那部功率和天线都很小的手机。
