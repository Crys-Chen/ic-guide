...
设计让无线信号穿越空间的高频模拟芯片。从 5G 手机、毫米波雷达到卫星互联网，凡是要无线传信息的地方都离不开它。
...
<div><svg viewBox="0 0 880 320" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:880px;display:block;margin:1.5rem auto;">
  ...
  <text x="440" y="26" text-anchor="middle" font-size="15" font-weight="bold" fill="#1E293B">低频电路 vs 射频电路：同一根导线的两种面貌</text>
  <line x1="440" y1="48" x2="440" y2="298" stroke="#CBD5E1" stroke-width="1.2" stroke-dasharray="4,4"/>
  <!-- ===== LEFT: low frequency ===== -->
  <text x="220" y="66" text-anchor="middle" font-size="12" font-weight="bold" fill="#475569">低频：导线 ≈ 理想连接</text>
  ...
  <text x="220" y="196" text-anchor="middle" font-size="11" fill="#16A34A">信号原样通过</text>
  <text x="220" y="230" text-anchor="middle" font-size="11" fill="#475569">不损耗 · 不延迟 · 不辐射</text>
  <!-- ===== RIGHT: radio frequency ===== -->
  <text x="660" y="66" text-anchor="middle" font-size="12" font-weight="bold" fill="#1E40AF">射频（GHz）：导线 = 分布的 L、C + 寄生</text>
  ...
  <text x="660" y="284" text-anchor="middle" font-size="11" fill="#1E40AF">几毫米导线也成了电感（改相位），还有对地/互耦电容与辐射</text>
</svg></div>
...
<div><svg viewBox="0 0 860 220" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:860px;display:block;margin:1.5rem auto;">
  ...
  <!-- Title labels -->
  <text x="430" y="18" text-anchor="middle" font-size="13" font-weight="bold" fill="#1E293B">收发机（Transceiver）框图</text>
  <!-- Antenna symbol (left) -->
  ...
  <text x="48" y="168" text-anchor="middle" font-size="11" fill="#475569">天线</text>
  ...
  <text x="180" y="81" text-anchor="middle" font-size="10" fill="#1D4ED8">低噪声放大器</text>
  <!-- LNA → Mixer -->
  ...
  <text x="311" y="81" text-anchor="middle" font-size="10" fill="#1D4ED8">混频器（下变频）</text>
  <!-- Mixer → ADC -->
  ...
  <text x="436" y="81" text-anchor="middle" font-size="10" fill="#1D4ED8">模数转换</text>
  <!-- ADC → Baseband -->
  ...
  <text x="436" y="186" text-anchor="middle" font-size="10" fill="#991B1B">数模转换</text>
  <!-- DAC → PA -->
  ...
  <text x="311" y="186" text-anchor="middle" font-size="10" fill="#991B1B">功率放大器</text>
  <!-- PA → Antenna -->
  ...
  <text x="180" y="186" text-anchor="middle" font-size="10" fill="#991B1B">混频器（上变频）</text>
  <!-- PA ← Mixer TX -->
  ...
  <text x="705" y="122" text-anchor="middle" font-size="10" fill="#166534">本振（LO）信号源</text>
  ...
  <!-- Labels -->
  <text x="180" y="38" text-anchor="middle" font-size="11" fill="#3B82F6">RX 接收链路</text>
  <text x="311" y="210" text-anchor="middle" font-size="11" fill="#DC2626">TX 发射链路</text>
  <text x="705" y="150" text-anchor="middle" font-size="10" fill="#166534">为 RX/TX 提供载波频率</text>
</svg></div>
...
<div><svg viewBox="0 0 860 300" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:860px;display:block;margin:1.5rem auto;">
  ...
  <text x="430" y="23" text-anchor="middle" font-size="15" font-weight="bold" fill="#1E293B">无线链路的功率预算示意</text>
  <!-- y axis -->
  <line x1="95" y1="45" x2="95" y2="272" stroke="#475569" stroke-width="1.2"/>
  <text x="95" y="40" text-anchor="middle" font-size="11" fill="#475569">功率/dBm</text>
  <text x="88" y="67" text-anchor="end" font-size="11" fill="#475569">+30</text>
  <text x="88" y="108" text-anchor="end" font-size="11" fill="#475569">0</text>
  <text x="88" y="177" text-anchor="end" font-size="11" fill="#475569">-50</text>
  <text x="88" y="245" text-anchor="end" font-size="11" fill="#475569">-100</text>
  <!-- PA output -->
  <circle cx="150" cy="64" r="4" fill="#003F88"/>
  <text x="150" y="54" text-anchor="middle" font-size="10" fill="#1E3A8A">PA 输出 +30 dBm（≈1 W）</text>
  <!-- path loss lines -->
  <line x1="150" y1="64" x2="620" y2="201" stroke="#2563EB" stroke-width="2.2"/>
  <text x="455" y="150" text-anchor="middle" font-size="10" fill="#2563EB">2.4 GHz</text>
  <line x1="150" y1="64" x2="620" y2="242" stroke="#C2410C" stroke-width="2.2"/>
  <text x="455" y="212" text-anchor="middle" font-size="10" fill="#C2410C">28 GHz（多损耗约 20 dB）</text>
  ...
  <text x="734" y="259" text-anchor="start" font-size="10" fill="#B91C1C">噪声地板 ≈ -110 dBm</text>
  <text x="430" y="270" text-anchor="middle" font-size="10" fill="#9A3412">接收 -100 dBm（0.1 pW）</text>
  <!-- gap arrow -->
  ...
  <text x="708" y="150" text-anchor="start" font-size="10" fill="#475569">动态范围</text>
  <text x="708" y="164" text-anchor="start" font-size="10" fill="#475569">≈ 130 dB（13 个数量级）</text>
  <!-- phased array lift -->
  ...
  <!-- stage labels -->
  <text x="150" y="288" text-anchor="middle" font-size="11" fill="#475569">PA 输出</text>
  <text x="385" y="288" text-anchor="middle" font-size="11" fill="#475569">自由空间传播</text>
  <text x="620" y="288" text-anchor="middle" font-size="11" fill="#475569">接收 / LNA</text>
</svg></div>
...
<div><svg viewBox="0 0 820 240" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:820px;display:block;margin:1.5rem auto;">
  ...
  <text x="410" y="23" text-anchor="middle" font-size="15" font-weight="bold" fill="#1E293B">超低功耗收发机的占空比工作方式</text>
  <!-- axes -->
  <line x1="70" y1="45" x2="70" y2="200" stroke="#475569" stroke-width="1.2"/>
  <text x="64" y="40" text-anchor="end" font-size="11" fill="#475569">功耗</text>
  <line x1="70" y1="200" x2="788" y2="200" stroke="#475569" stroke-width="1.2" marker-end="url(#dcAxis)"/>
  <text x="792" y="204" text-anchor="start" font-size="11" fill="#475569">时间</text>
  ...
  <text x="78" y="172" text-anchor="start" font-size="10" fill="#B91C1C">平均功耗</text>
  <!-- annotations -->
  <text x="235" y="76" text-anchor="start" font-size="10" fill="#1E3A8A">唤醒发送（数十 mW，数毫秒）</text>
  <text x="437" y="197" text-anchor="middle" font-size="10" fill="#475569">休眠（数 µW）</text>
  <text x="410" y="225" text-anchor="middle" font-size="11" fill="#334155">平均功耗 ≈ 占空比 × 峰值功耗</text>
</svg></div>
...
- **毫米波收发机与相控阵前端**：路径损耗约与频率平方成正比，28 GHz 比 2.4 GHz 同距离多衰减约 20 dB，只能把上百个天线单元、移相器和封装天线塞进指甲盖大小的模组拧出波束抢回能量。
- **功率放大器的线性-效率两难**：大功率要把晶体管推进非线性区会冒谐波污染邻道，想保持线性又得回退工作点、效率塌掉，毫米波 PA 与 Doherty、数字预失真都在这道坎上打转。
- **低相噪频率综合**：本振到了几十 GHz 还要既不偏也不抖，亚采样锁相环和全数字锁相环各走一路，相位噪声直接决定收发机能不能收对符号。
- **超低功耗物联网与可穿戴无线**：手环、植入体、田间传感器不缺带宽只缺续航，纽扣电池要撑十年，逼着同一批模块在纳安电流下保灵敏度、能彻底关断又快速醒来。
- **太赫兹收发与器件**：频率推上 300 GHz 以上晶体管增益近枯竭，长期找不到趁手的有源器件，太赫兹 CMOS 收发机和新型器件都在这条增益死线上抠裕量。
- **数字化射频与片上集成（IC 切口）**：把 PA、PLL、相控阵尽量搬进数字域用 ADPLL、数字 PA 实现，省下模拟校准又吃工艺缩放红利，但高频下数字逼近模拟性能仍是开放题。
...
适合精打细算的人。这一行的思维方式是记账，高频路线算链路预算，每个 dB 的来去都要有交代；低功耗路线算能量预算，每个比特的能耗锱铢必较。课程上模拟电路是基础，真正的分水岭在电磁场，觉得史密斯圆图和 S 参数顺手才算入门。日常一半在仿真里抠电路和走线，一半在测试间跟网络分析仪、频谱仪打交道，毫米波的测量本身就是门手艺。流片半年一轮，仿真和实测对不上是常态，得有排查到底的韧性。
