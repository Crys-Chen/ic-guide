...
二十年前，一部手机只能打电话、发短信；今天，时速三百公里的高铁上也能开视频会议、看直播。这是无线越来越快的一面。它还有另一面：手腕上的运动手环、随身的门禁卡、植入体内的起搏器，靠一颗小电池就能安静工作十年。把各种无线需求摊开，归根结底无非四个字——多快好省，也就是传得多、传得快、传得准、传得省。射频与毫米波集成电路，做的就是把信息这样送出去。难处在于这四样彼此牵制，没有一颗芯片能样样占全：要传得多、传得快，就得占用更宽的频段、推向更高的频率，可频率越高越费电、器件越难做，恰好和“省”相反；要传得准，又得搭上更多功率和带宽。于是同一门学问分出两副面孔，一面往高频走、争取带宽，一面往低功耗压、争取续航，而“传得准”是两边都绕不开的底线。这个方向的研究，大多就是在这四者之间，和物理反复权衡。
