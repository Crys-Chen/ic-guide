...
<div><svg viewBox="0 0 1140 532" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:1140px;display:block;margin:1.5rem auto;font-family:system-ui,-apple-system,sans-serif;">
  ...
  <text x="348" y="317" text-anchor="middle" font-size="13" font-weight="bold" fill="#DC2626">射频与</text>
  <text x="348" y="332" text-anchor="middle" font-size="13" font-weight="bold" fill="#DC2626">毫米波IC</text>
</svg></div>
