...
hide:
  - navigation
---
研究让模型更聪明、跑得更高效的整条链路。模型怎么变强、系统跑不跑得动、拿什么数据喂它，这三件事被同一堵墙逼着一起往前。
...
<div><svg viewBox="0 0 760 340" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:760px;display:block;margin:1.5rem auto;font-family:system-ui,-apple-system,sans-serif;">
  ...
  <text x="380" y="30" text-anchor="middle" font-size="14" font-weight="bold" fill="#1E293B">规模扩展的边际收益递减</text>
...
<div><svg viewBox="0 0 820 400" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:820px;display:block;margin:1.5rem auto;font-family:system-ui,-apple-system,sans-serif;">
  ...
  <text x="410" y="26" text-anchor="middle" font-size="14" font-weight="bold" fill="#1E293B">内存墙：注意力的瓶颈在于频繁访存</text>
  <text x="410" y="44" text-anchor="middle" font-size="11" fill="#64748B">Flash Attention 通过分块将计算保持在片上，减少 HBM 访问</text>
  ...
  <text x="210" y="127" text-anchor="middle" font-size="11" fill="#9F1239">计算核心 · 片上 SRAM</text>
  <rect x="64" y="248" width="292" height="44" rx="6" fill="#FECACA" stroke="#EF4444" stroke-width="1.2"/>
  <text x="210" y="275" text-anchor="middle" font-size="11" fill="#7F1D1D">片外显存 HBM</text>
  ...
  <text x="210" y="201" text-anchor="middle" font-size="10" font-weight="bold" fill="#B91C1C">中间结果反复读写</text>
  ...
  <text x="660" y="126" text-anchor="middle" font-size="10.5" fill="#166534">分块在片上完成</text>
...
适合真心对“让模型更聪明、更高效”有热情的人。这个方向是整个集成电路领域最贴近 AI 的。如果做纯算法，那迭代节奏全领域最快，成果挂 arXiv，论文短平快，今天的 SOTA 三个月后就被刷掉，跟得上会兴奋，跟不上会焦虑。日常就是写 PyTorch、改模型、在 GPU 集群上排队跑实验。如果结合系统和硬件架构，那就是 AI Infra 了，非常适合微电子出身的同学。系统侧，量化、推理优化这些贴硬件的活，我们能从访存带宽理解它为什么省，纯软件出身的人未必有这个直觉；越往纯算法和理论走，数学要求越重，得下决心补，靠硬件直觉硬扛不过去。
