...
- **操作·运动·导航三道身体坎**：抓取、双足平衡、陌生环境定位，是小孩的本能、AI 的难关，还没法从网上学。
- **VLA 借脑的边界**：大模型能把世界知识迁到动作上，可每项灵巧操作仍要海量真人示范，泛化卡在数据还是身体。
- **经验从哪来**：仿真有 Sim-to-Real 鸿沟、真机示范贵、在线学习又慢又险还会灾难性遗忘。
...
核心圈是机器人和机器学习（ICRA/RSS/CoRL），想进迟早得补机器人学和强化学习，光守芯片那侧不够。微电子本科最稳的切入口在硬件，机器人 SoC、边缘 AI 推理、触觉视觉传感前端，把 VLA 压进十几瓦预算，正是产业最缺的交叉人才。适合不满足于"屏幕里聪明"、能忍 Sim-to-Real 这类脏活的人。方向仍在剧烈变形、不确定性高，但开放问题也最多。
