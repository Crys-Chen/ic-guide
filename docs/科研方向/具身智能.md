...
最强的 AI 能考过律师资格、写出能跑的代码、下赢人类围棋冠军，可它拿不起你桌上那个杯子，也走不稳一段不平的路。一岁小孩随手就能做到的事，放到机器人身上反而成了登天的难。这个反差有个名字，叫 **Moravec 悖论**。对计算机来说，"动脑"出奇地容易，"动手"却出奇地难。具身智能（Embodied Intelligence）研究的，就是怎么让 AI 跨过从"**会想**"到"**会做**"这道坎，拥有一个能在真实物理世界里感知、决策、行动的身体。

先看看"会做"到底有多难。它不是一件事，而是一整套身体本能，至少有三样，每一样都把机器人难住了几十年。第一样是**操作**。让机器人把一个没见过的杯子拿起来放进洗碗机，人不假思索就做了，机器却要同时解决一大堆问题。它得先认出杯子，而杯子的形状、颜色、被挡住多少都可能不一样。还得估出杯子在空间里的朝向，再规划一条手臂轨迹绕开桌上别的东西。抓的时候每根手指要用恰好的力，太轻松手、太重捏碎。放进洗碗机时又得应付开门、搁架高低这些新情况。任何一环出错，整件事就崩，而人是把这些并行、无缝地一气做完的。第二样是**运动**。双足走路、在不平的地上保持平衡，看着轻巧，机器人却摔了几十年，人形和足式机器人至今还在为站稳、跑起来较劲。第三样是**导航**，走进一个陌生房间，要一边认路、一边随时知道自己在哪。这三样都是小孩的本能，可它们有一个共同的麻烦，那就是没法从网上学来。没人把"怎么用恰好的力气捏住杯子""打滑的瞬间怎么调整重心"写成文字，它们是身体在亿万次摸爬滚打里长出来的。
...
难归难，这两年研究者找到了一条捷径，把"会做"的一半先解决了。捷径就是**借脑**，把那些在互联网上训练出来的大模型，直接搬到机器人的决策上。2023 年 Google DeepMind 的 **RT-2** 就是这么干的，它把一个视觉-语言大模型直接当成机器人的"大脑"，输入是摄像头看到的画面加上一句指令，输出直接就是机械臂的动作。因为这个大模型在海量网络数据里见过世界，它能听懂训练时从没出现过的指令。你让它"把可乐罐放到和可口可乐 logo 同颜色的方块上"，它能自己推断出那是红色，再去做。这种举一反三的本事，是过去任何机器人都没有的。借来的，正是"会想"那一半，理解指令、认得杯子是杯子、知道红色是什么。可问题在于，**手上功夫那一半，互联网上没有，借不来**。

剩下"会做"的另一半，只能靠机器自己去挣。捏杯子的力度、走路的平衡，这种身体功夫没有现成答案，机器只能一次次真实地试、从结果里学。麻烦是真实的尝试又慢又贵，于是研究者凑出了三条攒经验的路，各有各的难处。第一条是**真人遥操作**，让人手把手地遥控机器人，把一个个动作示范给它看，π0 这类模型就靠海量的人类示范学会了叠衣服、装洗碗机，代价是请人示范极费工夫。第二条是**仿真**，在虚拟环境里让成千上万个机器人并行练习，又快又便宜，人形机器人的跑、跳、平衡几乎都是这么练出来的。但仿真里的物理和真实世界总对不上，这道**仿真到现实的鸿沟（Sim-to-Real）**让练好的技能一搬到真机就常常失灵，波士顿动力的 Atlas 一个跑酷动作，背后是上百万次仿真加大量真机试错。

第三条最诱人也最难，就是让机器人**自己在真实世界里边做边学**，也就是在线学习。这最像"越做越熟"的理想，可真机试错又慢、又有风险、还特别费样本，机器人摔一次可能就摔坏了。把这条路走通，再让机器人在部署之后还能持续学、自己纠错、适应没见过的新环境，就能把"攒经验"从一次性的训练变成一辈子的本事。说到底，**怎么让机器以扛得住的代价攒够身体经验，是整个具身智能最核心的难题**。

再往前看，有人想给机器人配上一种"想象力"，让它在脑子里建起一个物理世界的模型，真动手之前先预演一下"推这一下会怎样、松了手会不会倒"，这就是当下很热的**世界模型**和**空间智能**。具身智能整体还是个剧烈变形中的早期方向，视觉-语言-动作模型会长成什么样、灵巧操作到底卡在数据还是身体结构，眼下都没有定论。可也正因为没定型，真正的开放问题特别多，进来得早的人，有机会亲手定义这个领域的一部分。
