...
<div><svg viewBox="0 0 1140 532" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:1140px;display:block;margin:1.5rem auto;font-family:system-ui,-apple-system,sans-serif;">
  ...
  <rect x="914" y="88" width="76" height="298" rx="8" fill="none" stroke="#0F172A" stroke-width="3.5"/>
</svg></div>
...
- **灵巧操作与触觉力闭环**：抓取、手内操作、装配形状各异的物体，要靠触觉和力控在"太轻松手、太重捏碎"之间实时调节。
...
这个方向的日常一半在仿真里训练，一半在真机上调试。机器人会摔、会坏、练好的技能搬到现实常常失灵，得受得了跟硬件打交道的繁琐工程，同时要求一定的体能，价值几十万的机器人摔倒是常事。核心圈是机器人加机器学习，想进迟早要补机器人学和强化学习；微电子出身的切口在硬件侧，传感器读出、边缘推理、机器人 SoC，把大模型压进十几瓦的功耗预算就是现实的难题。整个领域还在剧烈变形，技术路线没有定型，适合喜欢开辟新方向、能忍受不确定性的人，进来得早，就有机会亲手定义它的一部分。
