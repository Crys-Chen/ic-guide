...
<div><svg viewBox="0 0 820 300" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:820px;display:block;margin:1.5rem auto;font-family:system-ui,sans-serif;">
  ...
  <text x="410" y="144" text-anchor="middle" font-size="10" fill="#64748B">实时运行 VLA · 几十亿参数</text>
  ...
  <text x="410" y="60" text-anchor="middle" font-size="10" font-weight="bold" fill="#B91C1C">散热墙 · 散热受限</text>
  ...
  <text x="410" y="282" text-anchor="middle" font-size="10.5" fill="#475569">再强的模型，也要在这颗芯片上实时运行。三堵墙把架构和能效推到最前线。</text>
</svg></div>
