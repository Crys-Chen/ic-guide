...
<div><svg viewBox="0 0 820 300" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:820px;display:block;margin:1.5rem auto;font-family:system-ui,sans-serif;">
  ...
  <text x="140" y="138" text-anchor="end" font-size="10" fill="#9A3412">只有十几瓦</text>
  ...
  <text x="680" y="138" text-anchor="start" font-size="10" fill="#9A3412">几十毫秒要出结果</text>
  ...
  <text x="190" y="244" text-anchor="middle" font-size="10" fill="#1D4ED8">+ 模型压缩</text>
  ...
  <text x="410" y="244" text-anchor="middle" font-size="9.5" fill="#166534">感知+决策+微秒级力矩控制</text>
  ...
  <text x="630" y="244" text-anchor="middle" font-size="10" fill="#B45309">触觉 / 视觉</text>
