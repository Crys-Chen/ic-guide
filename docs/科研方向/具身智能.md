...
这个方向的日常一半在仿真里训练，一半在真机上调试，机器人会摔、会坏、练好的技能搬到现实常常失灵，得受得了跟硬件耗的脏活，同时要求一定的体能（机器人摔倒扶不扶？）。核心圈是机器人加机器学习，想进迟早要补机器人学和强化学习；微电子出身的切口在硬件侧，传感器读出、边缘推理、机器人 SoC，把大模型塞进十几瓦的功耗预算就是眼下的热门难题。整个领域还在剧烈变形，技术路线没有定型，适合喜欢拓荒、能忍受不确定性的人，进来得早，就有机会亲手定义它的一部分。
