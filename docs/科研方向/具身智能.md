...
<div><svg viewBox="0 0 820 340" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:820px;display:block;margin:1.5rem auto;font-family:system-ui,sans-serif;">
  ...
  <text x="410" y="28" text-anchor="middle" font-size="13" font-weight="bold" fill="#1E293B">认知可迁移自互联网，技能只能靠本体反复采集</text>
  <rect x="372" y="62" width="76" height="46" rx="6" fill="#DBEAFE" stroke="#1E40AF" stroke-width="1.5"/>
  <text x="410" y="82" text-anchor="middle" font-size="12" font-weight="bold" fill="#1E40AF">认知</text>
  ...
  <text x="410" y="150" text-anchor="middle" font-size="12" font-weight="bold" fill="#15803D">执行</text>
  <text x="410" y="168" text-anchor="middle" font-size="10" fill="#166534">力控·平衡</text>
  <text x="410" y="181" text-anchor="middle" font-size="10" fill="#166534">灵巧操作</text>
  ...
  <text x="138" y="97" text-anchor="middle" font-size="10" fill="#64748B">海量文本 + 图像</text>
  <line x1="214" y1="84" x2="368" y2="84" stroke="#1D4ED8" stroke-width="2" marker-end="url(#emBorrow)"/>
  <text x="291" y="74" text-anchor="middle" font-size="11" font-weight="bold" fill="#1D4ED8">迁移</text>
  <text x="476" y="158" text-anchor="start" font-size="10" fill="#B91C1C">此类数据互联网缺失</text>
  <text x="476" y="172" text-anchor="start" font-size="10" fill="#B91C1C">无法迁移</text>
  <rect x="92" y="276" width="160" height="40" rx="6" fill="#FFF7ED" stroke="#C2410C" stroke-width="1.3"/>
  <text x="172" y="295" text-anchor="middle" font-size="10" font-weight="bold" fill="#9A3412">人工遥操作示范</text>
  <text x="172" y="309" text-anchor="middle" font-size="10" fill="#C2410C">成本高</text>
  <rect x="330" y="276" width="160" height="40" rx="6" fill="#FFF7ED" stroke="#C2410C" stroke-width="1.3"/>
  <text x="410" y="295" text-anchor="middle" font-size="10" font-weight="bold" fill="#9A3412">仿真训练</text>
  <text x="410" y="309" text-anchor="middle" font-size="10" fill="#C2410C">有 Sim-to-Real 鸿沟</text>
  <rect x="568" y="276" width="160" height="40" rx="6" fill="#FFF7ED" stroke="#C2410C" stroke-width="1.3"/>
  <text x="648" y="295" text-anchor="middle" font-size="10" font-weight="bold" fill="#9A3412">真机在线学习</text>
  <text x="648" y="309" text-anchor="middle" font-size="10" fill="#C2410C">慢·有风险·易遗忘</text>
  ...
  <text x="410" y="250" text-anchor="middle" font-size="11" font-weight="bold" fill="#C2410C">积累（反复采集经验）</text>
</svg></div>
...
<div><svg viewBox="0 0 820 300" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:820px;display:block;margin:1.5rem auto;font-family:system-ui,sans-serif;">
  ...
  <text x="410" y="28" text-anchor="middle" font-size="13" font-weight="bold" fill="#1E293B">具身芯片：把几十亿参数的 VLA 压进十几瓦、几十毫秒</text>
