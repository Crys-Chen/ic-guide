...
核心圈是机器人和机器学习，主舞台 ICRA/RSS/CoRL，想进迟早得补机器人学和强化学习。微电子本科最稳的切入口在硬件那侧，触觉与力传感器、灵巧手的驱动与读出、机器人 SoC、把 VLA 压进十几瓦预算的边缘推理，正是触觉灵巧手这类硬件公司和嵌入式 AI 课题组最缺的人。适合不满足于"屏幕里聪明"、愿意死磕 Sim-to-Real 这类脏活的人。方向仍在剧烈变形、不确定性高，但开放问题也最多。
