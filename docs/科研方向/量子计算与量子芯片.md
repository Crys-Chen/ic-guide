...
<div><svg viewBox="0 0 860 220" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:860px;display:block;margin:1.5rem auto;font-family:system-ui,sans-serif;">
  ...
  <text x="130" y="145" text-anchor="middle" font-size="11" fill="#64748B">确定性：每次只能是</text>
  <text x="130" y="162" text-anchor="middle" font-size="11" fill="#64748B">0 或 1 之一</text>
  <text x="130" y="195" text-anchor="middle" font-size="11" fill="#64748B">n位 = 2ⁿ 种状态之一</text>
  <!-- Arrow -->
  ...
  <!-- |0⟩ and |1⟩ poles -->
  <text x="427" y="50" text-anchor="middle" font-size="11" font-weight="600" fill="#6D28D9">|0⟩</text>
  <text x="427" y="178" text-anchor="middle" font-size="11" font-weight="600" fill="#6D28D9">|1⟩</text>
  ...
  <text x="478" y="74" font-size="11" fill="#6D28D9">|ψ⟩</text>
  <text x="427" y="195" text-anchor="middle" font-size="11" fill="#64748B">叠加态 | n量子比特 = 2ⁿ个状态同时</text>
  <!-- Arrow -->
  ...
  <text x="725" y="83" text-anchor="middle" font-size="10" fill="#166534">药物设计·材料发现</text>
  ...
  <text x="725" y="131" text-anchor="middle" font-size="10" fill="#92400E">Shor 算法·RSA 威胁</text>
  ...
  <text x="725" y="179" text-anchor="middle" font-size="10" fill="#5B21B6">QAOA·物流·金融</text>
  <text x="725" y="200" text-anchor="middle" font-size="10" fill="#64748B">经典计算机难以高效处理</text>
</svg></div>
...
<div><svg viewBox="0 0 860 240" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:860px;display:block;margin:1.5rem auto;font-family:system-ui,sans-serif;">
  ...
  <text x="28"  y="48" font-size="10" fill="#94A3B8">↑ 概率幅</text>
  <text x="328" y="48" font-size="10" fill="#94A3B8">↑ 概率幅</text>
  <text x="628" y="48" font-size="10" fill="#94A3B8">↑ 概率幅</text>
  ...
  <text x="130" y="182" text-anchor="middle" font-size="11" fill="#64748B">所有答案概率幅相等</text>
  <text x="130" y="196" text-anchor="middle" font-size="10" fill="#94A3B8">尚未进行计算</text>
  ...
  <text x="452" y="73" text-anchor="middle" font-size="10" fill="#7C3AED">正确答案 ↑</text>
  <text x="430" y="182" text-anchor="middle" font-size="11" fill="#64748B">错误答案相消（↓）· 正确答案叠加（↑）</text>
  <text x="430" y="196" text-anchor="middle" font-size="10" fill="#94A3B8">干涉作用于概率幅</text>
  ...
  <text x="730" y="182" text-anchor="middle" font-size="11" fill="#64748B">几乎总能测到正确答案</text>
  <text x="730" y="196" text-anchor="middle" font-size="10" fill="#94A3B8">一次测量即得结果</text>
  <!-- inter-panel arrows -->
...
<div><svg viewBox="0 0 860 310" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:860px;display:block;margin:1.5rem auto;font-family:system-ui,sans-serif;">
  ...
  <text x="112" y="270" text-anchor="middle" font-size="10" font-weight="600" fill="#15803D">Vin=高 → NMOS 导通 → 接地</text>
  <text x="112" y="284" text-anchor="middle" font-size="10" fill="#15803D">Vout ≈ 0V → bit = 0</text>
  <rect x="213" y="255" width="184" height="36" rx="3" fill="#DBEAFE" stroke="#3B82F6" stroke-width="1"/>
  <text x="305" y="270" text-anchor="middle" font-size="10" font-weight="600" fill="#1D4ED8">Vin=低 → PMOS 导通 → 接 VDD</text>
  <text x="305" y="284" text-anchor="middle" font-size="10" fill="#1D4ED8">Vout ≈ VDD → bit = 1</text>
  ...
  <text x="482" y="152" text-anchor="middle" font-size="10" fill="#7C3AED">并联电容</text>
  <!-- Right branch: JJ -->
  ...
  <text x="757" y="161" font-size="10" fill="#6D28D9">（非线性电感）</text>
  <!-- Microwave arrow -->
  ...
  <!-- Loop label -->
  <text x="625" y="220" text-anchor="middle" font-size="10" fill="#7C3AED">C 与 JJ 并联，构成非线性谐振回路</text>
  <!-- State boxes -->
...
<div><svg viewBox="0 0 860 285" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:860px;display:block;margin:1.5rem auto;font-family:system-ui,sans-serif;">
  ...
  <text x="281" y="143" text-anchor="middle" font-size="9" fill="#94A3B8">换入 JJ</text>
  <line x1="563" y1="148" x2="603" y2="148" stroke="#94A3B8" stroke-width="2" marker-end="url(#a3)"/>
  <text x="583" y="143" text-anchor="middle" font-size="9" fill="#94A3B8">微波寻址</text>
  ...
  <text x="128" y="57" text-anchor="middle" font-size="11" font-weight="600" fill="#1D4ED8">线性电感 L  +  电容 C</text>
  <text x="128" y="74" text-anchor="middle" font-size="10" fill="#1D4ED8">构成 LC 谐振回路</text>
  ...
  <text x="128" y="267" text-anchor="middle" font-size="10" fill="#64748B">能级均匀 → 微波无法定向寻址</text>
  ...
  <text x="430" y="57" text-anchor="middle" font-size="11" font-weight="600" fill="#7C3AED">约瑟夫森结（非线性电感）</text>
  <text x="430" y="74" text-anchor="middle" font-size="10" fill="#7C3AED">打破均匀间距</text>
  ...
  <text x="532" y="227" font-size="10" font-weight="600" fill="#7C3AED">Δ₀₁</text>
  ...
  <text x="532" y="193" font-size="10" fill="#94A3B8">Δ₁₂</text>
  <!-- ≠ symbol -->
  <text x="548" y="213" font-size="13" font-weight="700" fill="#7C3AED">≠</text>
  <text x="432" y="267" text-anchor="middle" font-size="10" fill="#64748B">Δ₀₁ ≠ Δ₁₂ → 可单独寻址最低两能级</text>

  <!-- ── Panel 3: qubit ── -->
  <rect x="632" y="38" width="199" height="44" rx="6" fill="#EDE9FE" stroke="#7C3AED" stroke-width="1.5"/>
  <text x="732" y="57" text-anchor="middle" font-size="11" font-weight="600" fill="#7C3AED">人工"原子"</text>
  <text x="732" y="74" text-anchor="middle" font-size="10" fill="#7C3AED">基态 = |0⟩  激发态 = |1⟩</text>
  ...
  <text x="734" y="186" text-anchor="middle" font-size="10" fill="#CBD5E1">不参与计算</text>
  ...
  <text x="734" y="267" text-anchor="middle" font-size="10" fill="#64748B">特定频率微波单独操控 |0⟩ 和 |1⟩</text>
</svg></div>
...
<div><svg viewBox="0 0 860 235" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:860px;display:block;margin:1.5rem auto;font-family:system-ui,sans-serif;">
  ...
  <text x="112" y="56"  font-size="10" fill="#64748B">室温</text>
  <rect x="240" y="37"  width="122" height="17" rx="3" fill="#FEE2E2"/>
  <text x="301" y="49"  text-anchor="middle" font-size="10" fill="#EF4444">kT = 25 meV</text>
  <!-- 77 K -->
  ...
  <text x="112" y="93"  font-size="10" fill="#64748B">液氮预冷</text>
  <rect x="240" y="75"  width="122" height="17" rx="3" fill="#FED7AA"/>
  <text x="301" y="87"  text-anchor="middle" font-size="10" fill="#EA580C">kT = 6.6 meV</text>
  <!-- 4 K -->
  ...
  <text x="112" y="131" font-size="10" fill="#64748B">液氦 / 4 K CMOS 层</text>
  <rect x="240" y="113" width="122" height="17" rx="3" fill="#FEF9C3"/>
  <text x="301" y="125" text-anchor="middle" font-size="10" fill="#CA8A04">kT = 0.34 meV</text>
  <!-- 100 mK -->
  ...
  <text x="112" y="169" font-size="10" fill="#64748B">预冷级</text>
  <rect x="240" y="151" width="122" height="17" rx="3" fill="#DCFCE7"/>
  <text x="301" y="163" text-anchor="middle" font-size="10" fill="#16A34A">kT = 8.6 μeV</text>
  <!-- 20 mK -->
  ...
  <text x="301" y="211" text-anchor="middle" font-size="10" font-weight="600" fill="#1D4ED8">kT = 1.7 μeV</text>
