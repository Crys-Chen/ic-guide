...
- [本源量子（Origin Quantum）](https://originqc.com.cn/) — 国内量子计算龙头，自主超导量子计算机"本源悟空"（未上市）
- [国盾量子（QuantumCTek）](https://www.quantum-info.com/) · [实时股价](https://quote.eastmoney.com/sh688027.html) — 量子通信/计算/精密测量，"量子科技第一股"
- [华为](https://www.huawei.com/cn/)（华为量子计算软件与硬件路线，华为未上市）
- [百度量子（Baidu Quantum）](https://quantum.baidu.com/) · [实时股价](https://finance.yahoo.com/quote/BIDU) — 量子平台「量易伏」与量子机器学习
