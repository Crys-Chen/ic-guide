...
<div><svg viewBox="0 0 860 310" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:860px;display:block;margin:1.5rem auto;font-family:system-ui,sans-serif;">
  ...
  <!-- Microwave arrow -->
  <line x1="625" y1="50" x2="625" y2="74" stroke="#D97706" stroke-width="2" stroke-dasharray="4,3" marker-end="url(#arr-mw)"/>
  <text x="625" y="45" text-anchor="middle" font-size="10" font-weight="600" fill="#D97706">微波脉冲</text>
  <!-- Loop label -->
...
<div><svg viewBox="0 0 860 275" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:860px;display:block;margin:1.5rem auto;font-family:system-ui,sans-serif;">
  <defs>
  ...
  <!-- 2 panels -->
  <rect x="5"   y="5" width="385" height="265" rx="8" fill="#F8FAFC" stroke="#CBD5E1" stroke-width="1.5"/>
  <rect x="470" y="5" width="385" height="265" rx="8" fill="#F8FAFC" stroke="#CBD5E1" stroke-width="1.5"/>
  <!-- titles -->
  ...
  <!-- 4K: y=111 -->
  <rect x="485" y="111" width="340" height="58" rx="7" fill="#FEF9C3" stroke="#CA8A04" stroke-width="1.8"/>
  <text x="655" y="136" text-anchor="middle" font-size="11" font-weight="700" fill="#CA8A04">4 K  低温区</text>
  <text x="655" y="156" text-anchor="middle" font-size="9"  fill="#334155">低温 CMOS 控制芯片  ←  微电子切入口</text>
  <!-- 20mK: y=185 -->
  <rect x="485" y="185" width="340" height="58" rx="7" fill="#DBEAFE" stroke="#1D4ED8" stroke-width="1.8"/>
  <text x="655" y="210" text-anchor="middle" font-size="11" font-weight="700" fill="#1D4ED8">20 mK</text>
  <text x="655" y="230" text-anchor="middle" font-size="9"  fill="#334155">量子芯片  ·  超导量子比特阵列</text>
  ...
  <line x1="530" y1="170" x2="530" y2="184" stroke="#94A3B8" stroke-width="1" stroke-dasharray="3,2"/>
  <line x1="555" y1="170" x2="555" y2="184" stroke="#94A3B8" stroke-width="1" stroke-dasharray="3,2"/>
  <line x1="580" y1="170" x2="580" y2="184" stroke="#94A3B8" stroke-width="1" stroke-dasharray="3,2"/>
  <line x1="605" y1="170" x2="605" y2="184" stroke="#94A3B8" stroke-width="1" stroke-dasharray="3,2"/>
  <line x1="630" y1="170" x2="630" y2="184" stroke="#94A3B8" stroke-width="1" stroke-dasharray="3,2"/>
  <line x1="655" y1="170" x2="655" y2="184" stroke="#94A3B8" stroke-width="1" stroke-dasharray="3,2"/>
  <line x1="680" y1="170" x2="680" y2="184" stroke="#94A3B8" stroke-width="1" stroke-dasharray="3,2"/>
  <line x1="705" y1="170" x2="705" y2="184" stroke="#94A3B8" stroke-width="1" stroke-dasharray="3,2"/>
  <line x1="730" y1="170" x2="730" y2="184" stroke="#94A3B8" stroke-width="1" stroke-dasharray="3,2"/>
  <text x="655" y="168" text-anchor="middle" font-size="8" fill="#94A3B8">↑ 控制线 &gt;100 条 ↑</text>
  <!-- gap2: 4K bottom (169)–300K top? No: 300K ends at 95, 4K starts at 111. Gap = y=95–111 (16px) -->
  <line x1="595" y1="96"  x2="595" y2="110" stroke="#16A34A" stroke-width="1.5" stroke-dasharray="4,2"/>
  <line x1="655" y1="96"  x2="655" y2="110" stroke="#16A34A" stroke-width="1.5" stroke-dasharray="4,2"/>
  <line x1="715" y1="96"  x2="715" y2="110" stroke="#16A34A" stroke-width="1.5" stroke-dasharray="4,2"/>
  <text x="655" y="108" text-anchor="middle" font-size="8" fill="#16A34A">↑ 4K集成后互连大幅减少 ↑</text>
</svg></div>
