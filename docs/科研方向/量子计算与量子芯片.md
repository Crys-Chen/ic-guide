...
- [本源量子（Origin Quantum）](https://originqc.com.cn/) — 国内量子计算龙头，超导量子计算机"本源悟空"、硅基量子点与量子测控系统（未上市）
- [国盾量子（QuantumCTek）](https://www.quantum-info.com/) · [实时股价](https://quote.eastmoney.com/sh688027.html) — 超导量子整机、量子测控系统与稀释制冷机，"量子科技第一股"
- [量旋科技（SpinQ）](https://www.spinq.cn/) — 超导/核磁全栈自研，"少微"超导芯片与"织女星"量子测控系统（未上市）
- [启科量子（Qudoor）](https://www.qudoor.com/) — 离子阱路线，"天算1号"模块化离子阱量子计算工程机（未上市）
- [图灵量子（TuringQ）](https://www.turingq.com/) — 集成光量子计算芯片（薄膜铌酸锂），TuringQ Gen2（未上市）
- [玻色量子（QBoson）](https://www.qboson.com/) — 相干光量子计算机（相干伊辛机 CIM），组合优化加速（未上市）
- [华为](https://www.huawei.com/cn/)（华为量子计算软件与硬件路线，华为未上市）
- [腾讯量子实验室](https://quantum.tencent.com/) · [实时股价](https://quote.eastmoney.com/hk/00700.html) — 量子算法与量子化学模拟

**国外**

- [IBM Quantum](https://www.ibm.com/quantum) · [实时股价](https://finance.yahoo.com/quote/IBM) — 超导路线、Qiskit 生态领导者
- [Google Quantum AI](https://quantumai.google/) · [实时股价](https://finance.yahoo.com/quote/GOOGL) — 超导芯片 Sycamore / Willow
- [Intel Quantum](https://www.intel.com/content/www/us/en/research/quantum-computing.html) · [实时股价](https://finance.yahoo.com/quote/INTC) — 硅自旋量子点路线
- [IonQ](https://ionq.com/) · [实时股价](https://finance.yahoo.com/quote/IONQ) — 离子阱路线纯量子上市公司
- [Rigetti Computing](https://www.rigetti.com/) · [实时股价](https://finance.yahoo.com/quote/RGTI) — 超导量子芯片
- [D-Wave Quantum](https://www.dwavequantum.com/) · [实时股价](https://finance.yahoo.com/quote/QBTS) — 量子退火系统
- [Xanadu](https://www.xanadu.ai/) · [实时股价](https://finance.yahoo.com/quote/XNDU) — 光量子计算（首家上市纯光量子公司）、PennyLane 框架
- [PsiQuantum](https://www.psiquantum.com/)（硅光量子计算，Omega 光子芯片，未上市）
- [Quandela](https://www.quandela.com/)（单光子源光量子计算，欧洲光量子龙头，未上市）
- [Quantinuum](https://www.quantinuum.com/)（霍尼韦尔系，离子阱，拟登陆纳斯达克，未上市）
- [QuEra Computing](https://www.quera.com/)（中性原子路线，Harvard/MIT 衍生，未上市）
- [Pasqal](https://www.pasqal.com/)（中性原子路线，法国，拟上市，未上市）
- [Atom Computing](https://www.atom-computing.com/)（中性原子路线，微软 Azure 合作，未上市）
- [Keysight（是德科技）](https://www.keysight.com/ca/en/products/modular/pxi-products/quantum-control-system.html) · [实时股价](https://finance.yahoo.com/quote/KEYS) — 量子测控系统 QCS 与控制电子学
- [Quantum Machines](https://www.quantum-machines.co/)（OPX 量子测控平台，跨技术路线，未上市）
- [Qblox](https://www.qblox.com/)（模块化量子控制电子学，荷兰，未上市）

### 科研院所

**国内**

- [中国科学院量子信息与量子科技创新研究院](http://www.quantumcas.ac.cn/) — 依托中国科大，"九章"光量子与"祖冲之"超导量子优越性
- [中国科学技术大学·量子物理与量子信息研究部](https://quantum.ustc.edu.cn/) — 潘建伟团队，国内量子计算旗舰
- [之江实验室](https://www.zhejianglab.org/) — 量子精密测量大科学装置、抗量子隐私计算
- [北京量子信息科学研究院（BAQIS）](https://www.baqis.ac.cn/) — 超导量子比特、量子材料与低温测控

**国外**

- [QuTech（代尔夫特理工 + TNO）](https://qutech.nl/) — 硅自旋/超导量子比特与低温控制电子学
- [MIT 量子工程组（EQuS / RLE）](https://equs.mit.edu/) — 超导量子电路与约瑟夫森结
- [Harvard Quantum Initiative（HQI）](https://quantum.harvard.edu/) — 中性原子/里德堡阵列（Lukin 组，QuEra 源头）
- [Bristol QET Labs](https://www.bristol.ac.uk/qet-labs/) — 集成光量子芯片与硅光量子（PsiQuantum 源头）
- [imec](https://www.imec-int.com/en) — 硅基量子比特量产工艺与低温 CMOS
- [Yale Quantum Institute](https://quantuminstitute.yale.edu/) — 超导量子电路（circuit QED 发源地）

## 顶会顶刊

**顶会**：QIP（量子信息处理）· IEEE QCE（Quantum Week）· ISSCC / JSSC（低温控制芯片）· APS March Meeting

**顶刊**：Nature · Science · Nature Physics · PRX Quantum · Physical Review Letters (PRL) · npj Quantum Information
