...
- [本源量子（Origin Quantum）](https://originqc.com.cn/) <span class="sq-none">未上市</span>
- [国盾量子（QuantumCTek）](https://www.quantum-info.com/) <span class="sq" data-stock="sh:688027"></span>
- [量旋科技（SpinQ）](https://www.spinq.cn/) <span class="sq-none">未上市</span>
- [启科量子（Qudoor）](https://www.qudoor.com/) <span class="sq-none">未上市</span>
- [图灵量子（TuringQ）](https://www.turingq.com/) <span class="sq-none">未上市</span>
- [玻色量子（QBoson）](https://www.qboson.com/) <span class="sq-none">未上市</span>
- [华为](https://www.huawei.com/cn/) <span class="sq-none">未上市</span>
- [腾讯量子实验室](https://quantum.tencent.com/) <span class="sq" data-stock="hk:00700"></span>

**国外**

- [IBM Quantum](https://www.ibm.com/quantum) <span class="sq" data-stock="us:IBM"></span>
- [Google Quantum AI](https://quantumai.google/) <span class="sq" data-stock="us:GOOGL"></span>
- [Intel Quantum](https://www.intel.com/content/www/us/en/research/quantum-computing.html) <span class="sq" data-stock="us:INTC"></span>
- [IonQ](https://ionq.com/) <span class="sq" data-stock="us:IONQ"></span>
- [Rigetti Computing](https://www.rigetti.com/) <span class="sq" data-stock="us:RGTI"></span>
- [D-Wave Quantum](https://www.dwavequantum.com/) <span class="sq" data-stock="us:QBTS"></span>
- [Xanadu](https://www.xanadu.ai/) <span class="sq" data-stock="us:XNDU"></span>
- [PsiQuantum](https://www.psiquantum.com/) <span class="sq-none">未上市</span>
- [Quandela](https://www.quandela.com/) <span class="sq-none">未上市</span>
- [Quantinuum](https://www.quantinuum.com/) <span class="sq-none">未上市</span>
- [QuEra Computing](https://www.quera.com/) <span class="sq-none">未上市</span>
- [Pasqal](https://www.pasqal.com/) <span class="sq-none">未上市</span>
- [Atom Computing](https://www.atom-computing.com/) <span class="sq-none">未上市</span>
- [Keysight（是德科技）](https://www.keysight.com/ca/en/products/modular/pxi-products/quantum-control-system.html) <span class="sq" data-stock="us:KEYS"></span>
- [Quantum Machines](https://www.quantum-machines.co/) <span class="sq-none">未上市</span>
- [Qblox](https://www.qblox.com/) <span class="sq-none">未上市</span>
