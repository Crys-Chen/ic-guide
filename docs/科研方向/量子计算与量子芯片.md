...
- **可扩展性与工艺一致性**：保护一个逻辑比特要数十到数百个物理比特，实用容错机意味着百万级规模，芯片制造与互连密度已逼近经典先进制程，而非线性能级靠两片超导体夹纳米绝缘层的约瑟夫森结实现，结尺寸与材料纯度的良率难以对接可量产工艺。
...
这个方向适合被极限条件工程吸引的人。你得有一只脚踏在量子力学和固体物理上，完全想回避物理的人不适合。微电子本科的切口很具体，不拼量子比特本身，而是做 4 K 低温 CMOS 控制芯片和微波测控链路，标准 CMOS 一冷到 4 K 器件模型全失效要从头标定，正是 IC 学生能立刻发力的地方。诚实提醒一句，容错量子机最乐观也要 2035 年以后，需要长线思维和补物理课的决心。
