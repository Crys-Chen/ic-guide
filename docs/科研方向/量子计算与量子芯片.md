...
<div><svg viewBox="0 0 1140 532" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:1140px;display:block;margin:1.5rem auto;font-family:system-ui,-apple-system,sans-serif;">
  ...
  <rect x="74" y="96" width="110" height="290" rx="9" fill="#1E293B" opacity="0.16"/>
  <rect x="71" y="92" width="110" height="290" rx="9" fill="#CFFAFE" stroke="#0E7490" stroke-width="2.6"/>
  <text x="126" y="229" text-anchor="middle" font-size="13" font-weight="bold" fill="#0E7490">量子计算</text>
  <text x="126" y="248" text-anchor="middle" font-size="13" font-weight="bold" fill="#0E7490">与量子芯片</text>
</svg></div>
...
- **量子算法与编译**：可编程量子模拟、量子机器学习，以及把算法映射到芯片连接拓扑、压缩操作次数的编译问题，在 NISQ 协处理器范式下既要贴硬件又要有实用价值。
...
适合愿意做长线的人，容错量子计算机最乐观也要 2035 年以后，迭代周期长。课程上量子力学和固体物理是必修，完全想回避物理的人不适合。微电子出身不拼量子比特本身，切口在测控那一侧，做 4 K 低温 CMOS 和微波链路，标准 CMOS 一冷到 4 K 器件模型全部失效，得从头标定。日常主要围绕稀释制冷机，接微波线缆、标定器件、跑测试，降一次温要好几天，实验节奏被制冷机的排期管着，适合被极限条件下的工程吸引、又耐得住的人。
