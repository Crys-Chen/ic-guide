...
| 姓名 | 单位 | 主页 | 研究方向 |
|------|------|------|----------|
| [陈弘威](https://web.ee.tsinghua.edu.cn/chenhongwei/en/index.htm) | 清华大学电子工程系 | 个人主页 | 硅光子、光电信号处理、光子智能计算、微波光子学，发表于 Nature Commun./Science Advances |
| [王建伟](https://faculty.pku.edu.cn/wangjianwei/en/index.htm) | 北京大学物理学院（国家杰青） | PKU 教授页 | 集成光子量子芯片、大规模硅基光子集成、量子计算与量子网络，Nature 2025 |
| [林强](https://photonics.pku.edu.cn/en/info/1022/1332.htm) | 北京大学先进集成光子实验室（博雅青年学者） | PKU 教师页 | 硅光子与铌酸锂平台、片上激光器与光频梳、量子光子网络，IEEE Photonics Society 青年研究者奖 |
| [迟楠](https://emwlab.fudan.edu.cn/e8/47/c37898a452679/page.htm) | 复旦大学信息科学与工程学院（国家杰青，OSA Fellow） | EMW Lab | 光子集成、可见光通信（LiFi）、GaN 基 Micro-LED 光子集成与高速可见光通信 |
| [程增光](https://sme.fudan.edu.cn/5f/cd/c31134a352205/page.htm) | 复旦大学微电子学院 | 复旦教师页 | 硅基光电子集成与设计、光子存储与计算、新型低维光电器件（牛津大学博士后出身） |
| [余金中](https://semi.cas.cn/rcdw/yjyjrc/rc_jycj/) | 中科院半导体研究所（中科院院士） | CAS 研究员页 | 硅基光电子器件与集成、片上光互联、光子集成电路 |
| [祝宁华](https://semi.cas.cn/rcdw/yjyjrc/rc_gtgd/) | 中科院半导体研究所（中科院院士） | CAS 院士页 | 微波光子学、高速光电子器件、宽带光信号产生与处理 |
| [邹卫文](http://imlic.sjtu.edu.cn) | 上海交通大学 | IMLIC Lab | 集成微光电子、硅光子收发芯片、高速光通信 |
| [蔡鑫伦](https://photonics.sysu.edu.cn/) | 中山大学光子学研究院 | 中大光子 | 薄膜铌酸锂（TFLN）光子集成、高速低功耗电光调制器 |

**国际**

| 姓名 | 单位 | 主页 | 研究方向 |
|------|------|------|----------|
| [Michal Lipson](http://lipson.ee.columbia.edu) | Columbia University | Lipson Nanophotonics Group | 硅光子学先驱，片上纳米光子器件、光调制器、光频梳 |
| [Vladimir Stojanovic](https://people.eecs.berkeley.edu/~stoja/) | UC Berkeley EECS | SLICE Lab | 光电集成系统设计，芯片内光互联，处理器-光子协同设计 |
| [Jelena Vuckovic](https://nqp.stanford.edu) | Stanford EE | Nanoscale & Quantum Photonics Lab | 光子晶体纳腔、逆向设计光子器件、量子光子集成 |
| [David Miller](https://ee.stanford.edu/~dabm/) | Stanford EE | Miller Group | 光互联物理先驱，硅基光调制器、芯片间光通信，SMART 光计算 |
| [Marin Soljačić](https://www.rle.mit.edu/marin/) | MIT Physics / RLE | Soljačić Group | 光子机器学习先驱，用逆向设计神经网络替代传统光学元件，深度学习与光子晶体交叉 |
| [Peter McMahon](https://mcmahonlab.com/) | Cornell Applied & Engineering Physics | McMahon Lab | 相干光计算（Coherent Ising Machine）、光学神经网络、量子-经典混合计算 |
| [Shanhui Fan](https://web.stanford.edu/group/fan/) | Stanford EE | Fan Group | 光子器件逆向设计、非互易光子学、光子计算与信息处理 |
