...
-   **[戴琼海](https://www.au.tsinghua.edu.cn/en/info/1080/3316.htm)** <span class="badge-tsinghua">清华</span>

    衍射光子计算 · 光学神经网络 · 光场计算与显微成像

-   **[方璐](https://www.luvision.net/)** <span class="badge-tsinghua">清华</span>

    光计算芯片设计（太极芯片） · 光电混合处理器 · 大规模光神经网络训练
