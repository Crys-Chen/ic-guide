...
适合对"计算机为什么能快"真正好奇、愿意在算法和电路两个抽象层之间来回切换的人。读 Transformer 时第一反应是这个矩阵乘要吃多少带宽、KV Cache 怎么放，就是对的信号。微电子本科在这条线上有天然优势，数字电路、计算机组成、时序的底子让你读得懂 RTL 和微架构，自然偏向 AI 加速器与 DSA 一侧，把矩阵乘电路、片上缓存、边缘 AI SoC 用 RTL 实打实做出来，正是寒武纪、地平线这类 AI 芯片公司最缺的人。代表舞台是 ISCA 和 MICRO。诚实地说，这里节奏比 AI 顶会慢，一篇论文要靠扎实的 RTL 实现撑着，奖励把问题挖深而非快速迭代。
