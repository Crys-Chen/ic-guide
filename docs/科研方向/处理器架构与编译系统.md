...
过去四十年，处理器的进步是一件相当无聊的事——不需要创意，只要跟着制程走。晶体管缩小一半，电路跑快一倍，功耗不变，Dennard 缩放定律让"力大砖飞"成了主旋律：同一个设计每隔两年在新制程上重新流片，什么架构都不用改，性能自动翻倍。创新存在，但并非必须。

这条路在 2005 年前后走到了尽头。晶体管越来越小，漏电流却没能等比缩小，热功耗密度触到了散热极限，主频从此钉死在 4GHz 附近将近二十年。2015 年之后制程推进本身也显著放缓——从 28nm 到 7nm 到 3nm，每一代的时间更长、成本更高、性能红利更小。与此同时，大语言模型把算力需求推上了另一条斜率：训练 GPT-4 所需的算力，比五年前的 GPT-2 多了将近一万倍。Hennessy 与 Patterson 把这个供需剪刀差称为"计算机架构的新黄金时代"：当力大砖飞不再奏效，架构的精细设计才回到舞台中央。这与大模型 scaling law 撞上天花板有几分相似——单纯堆参数的路也有尽头，真正有价值的工作发生在那之后。
