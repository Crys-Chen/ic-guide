...
- [华为海思（HiSilicon）](https://www.hisilicon.com/cn)（昇腾 NPU · 鲲鹏 ARM CPU，华为未上市）
- [寒武纪](https://www.cambricon.com) · [实时股价](https://quote.eastmoney.com/sh688256.html)（云边端 AI 处理器与指令集）
- [摩尔线程](https://www.mthreads.com) · [实时股价](https://quote.eastmoney.com/sh688795.html)（全功能国产 GPU，"国产 GPU 第一股"）
- [地平线](https://www.horizon.auto) · [实时股价](https://quote.eastmoney.com/hk/09660.html)（征程车载 AI 处理器与 BPU 架构）
- [海光信息](https://www.hygon.cn) · [实时股价](https://quote.eastmoney.com/sh688041.html)（x86 兼容 CPU 与深算 DCU）
- [龙芯中科](https://www.loongson.cn) · [实时股价](https://quote.eastmoney.com/sh688047.html)（自主指令集 LoongArch CPU）

**国外**

- [NVIDIA](https://www.nvidia.com) · [实时股价](https://finance.yahoo.com/quote/NVDA)（GPU 微架构与 CUDA 软件栈）
- [Apple](https://www.apple.com) · [实时股价](https://finance.yahoo.com/quote/AAPL)（自研 SoC 与 Neural Engine）
- [Google](https://cloud.google.com/tpu) · [实时股价](https://finance.yahoo.com/quote/GOOGL)（TPU 脉动阵列，母公司 Alphabet 上市）
- [AMD](https://www.amd.com) · [实时股价](https://finance.yahoo.com/quote/AMD)（CPU/GPU 与 ROCm，收购 Xilinx 后含 FPGA）
- [Qualcomm](https://www.qualcomm.com) · [实时股价](https://finance.yahoo.com/quote/QCOM)（移动 SoC 与 Hexagon NPU）
- [Intel](https://www.intel.com) · [实时股价](https://finance.yahoo.com/quote/INTC)（x86 CPU 微架构 · Gaudi 加速器）
- [Cerebras Systems](https://cerebras.ai) · [实时股价](https://finance.yahoo.com/quote/CBRS)（晶圆级 AI 处理器 WSE，领域专用架构，2026 年 Nasdaq 上市）
- [SiFive](https://www.sifive.com)（商用 RISC-V 处理器 IP，UC Berkeley 团队创立、未上市）
- [Tenstorrent](https://tenstorrent.com)（RISC-V CPU IP 与 Tensix AI 加速核，Jim Keller 掌舵、未上市）

### 科研院所

**国内**

- [中科院计算技术研究所](https://www.ict.ac.cn) — 处理器芯片重点实验室 · 开源 RISC-V（香山）· 智能处理器
- [中科院微电子研究所](https://www.ime.ac.cn) — 存算一体与新型计算架构 · 国产 EDA
- [之江实验室](https://www.zhejianglab.org) — 智能计算 · 算力系统与异构架构
- [鹏城实验室](https://www.pcl.ac.cn) — "鹏城云脑"大科学装置 · AI 算力基础设施

**国外**

- [MIT CSAIL](https://www.csail.mit.edu) — 稀疏张量加速器 · 高效深度学习硬件
- [UC Berkeley（Chipyard/Gemmini）](https://bar.eecs.berkeley.edu) — 敏捷 VLSI · 领域专用加速器 · RISC-V
- [ETH Zürich（PULP 平台）](https://pulp-platform.org) — 开源 RISC-V · 超低功耗并行架构
- [Intel Labs](https://www.intel.com/content/www/us/en/research/overview.html) — 体系结构前沿研究 · 新型计算

## 顶会顶刊

**顶会**：ISCA · MICRO · HPCA · ASPLOS（架构侧）· PLDI · CGO · OOPSLA（编译侧）· Hot Chips

**顶刊**：JSSC（IEEE J. Solid-State Circuits）· TC（IEEE Trans. Computers）· TCAD（IEEE Trans. CAD of ICs）· TACO（ACM Trans. Architecture and Code Optimization）· TOPLAS（ACM Trans. Programming Languages and Systems）
