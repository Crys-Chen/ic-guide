...
这条路在 2005 年前后走到了尽头。Dennard 缩放首先失效：晶体管越来越小，漏电流却没能等比缩小，热功耗密度触到了散热极限，主频从此钉死在 **4 GHz** 附近将近二十年。摩尔定律本身也在 2015 年之后显著放缓——从 28nm 到 7nm 到 3nm，每一代的时间更长、成本更高、性能红利更小。与此同时，大语言模型把算力需求推上了另一条斜率：训练 GPT-4 所需的算力，比五年前的 GPT-2 多了将近一万倍。Hennessy 与 Patterson 把这个供需剪刀差称为**"计算机架构的新黄金时代"**：当力大砖飞不再奏效，架构的精细设计才回到舞台中央。这与大模型 scaling law 撞上天花板有几分相似——单纯堆参数的路也有尽头，真正有价值的工作发生在那之后。
