...
<div><svg viewBox="0 0 1140 532" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:1140px;display:block;margin:1.5rem auto;font-family:system-ui,-apple-system,sans-serif;">
  ...
  <rect x="449" y="95" width="104" height="290" rx="9" fill="#1E293B" opacity="0.16"/>
  <rect x="447" y="92" width="104" height="290" rx="9" fill="#EDE9FE" stroke="#7C3AED" stroke-width="2.6"/>
  <text x="499" y="231" text-anchor="middle" font-size="13" font-weight="bold" fill="#7C3AED">存算一体</text>
  <text x="499" y="246" text-anchor="middle" font-size="13" font-weight="bold" fill="#7C3AED">与近存计算</text>
</svg></div>
