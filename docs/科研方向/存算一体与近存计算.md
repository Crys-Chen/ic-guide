...
<div><svg viewBox="0 0 880 380" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:880px;display:block;margin:1.5em auto;font-family:system-ui,-apple-system,sans-serif;">
  ...
  <text x="440" y="28" text-anchor="middle" font-size="16" font-weight="bold" fill="#1E293B">融合越深，能效越高，代价也越狠</text>
  <text x="440" y="50" text-anchor="middle" font-size="12" fill="#475569">计算离数据越来越近、与存储融合越来越深</text>
  ...
  <text x="763" y="253" text-anchor="middle" font-size="10.5" fill="#B91C1C">精度·ADC·器件三坎</text>
  ...
  <text x="470" y="351" text-anchor="middle" font-size="10" fill="#B91C1C">精度 · ADC · 器件成熟度越来越难</text>
</svg></div>
