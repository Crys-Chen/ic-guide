...
集成电路（微电子）这门学科，实在是包罗万象。我梳理下来，大概有17个科研方向。本科期间做科研，常感觉自己“只见树木，不见森林”。这几年东一榔头西一棒槌做下来，总算有了点系统的认知。如今即将毕业，我整理了过往对每个方向的笔记，尝试梳理出一个较为完整的学术谱系。现在将其分享出来，希望对大家了解这门学科有所帮助。

本文其实只是我本科笔记的冰山一角。目前我正在用 Vibe Coding 搭建一个网站，详细介绍每个科研方向究竟在研究什么、适合什么样的同学、需要哪些领域的知识、国内外有哪些知名课题组、哪些对口企业。整个集成电路学科相关的课程资源和学习地图，届时也会一并整理分享出来。某种程度上，这才是我真正的毕设。本文只是一个先导，敬请期待！



![image-20260606001044268](assets/image-20260606001044268.png)
...
![侧信道攻击：从加密运算到密钥泄露](assets/fig-18.png)
...
![量子计算：经典比特 → 量子比特 → 量子擅长的问题](assets/fig-19.png)
