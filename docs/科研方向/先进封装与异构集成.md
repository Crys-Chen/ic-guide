...
<div><svg viewBox="0 0 1140 532" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:1140px;display:block;margin:1.5rem auto;font-family:system-ui,-apple-system,sans-serif;">
  ...
  <rect x="92" y="438" width="1040" height="40" rx="6" fill="#1E293B" opacity="0.14"/>
  <rect x="92" y="434" width="1040" height="40" rx="6" fill="#EEF2F6" stroke="#64748B" stroke-width="2"/>
  <text x="612" y="459" text-anchor="middle" font-size="14" font-weight="bold" fill="#475569">先进封装与系统集成</text>
</svg></div>
...
- **异质材料与光电 I/O 集成**：III-V、玻璃基板、片上光互连各有所长，却和硅热膨胀失配、工艺互相污染，要把它们缝进同一个封装而不牺牲可靠性。
