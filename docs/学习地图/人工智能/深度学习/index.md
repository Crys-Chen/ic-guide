...
对硬件研究者来说,理解 CNN 的卷积、Transformer 的 attention 是**设计 AI 加速器的前提**——你得先知道工作负载长什么样,才能设计对应的硬件。
...
**入门:吴恩达 Coursera 或李宏毅**(选其一,中英文偏好)

**深度方向:**
- 视觉 → CS231n / EECS 498-007
- NLP / LLM → CS224n
- 图 / 推荐 → CS224w
- RL → CS285
...
- [AI 算法与系统](../../../科研方向/AI算法与系统.md) — 算法层核心
- [类脑芯片](../../../科研方向/类脑芯片.md) — SNN/Neuromorphic 共享 DL 训练框架
- [具身智能](../../../科研方向/具身智能.md) — DL + RL + LLM Agent 是当前主流
