...
- **[分析](分析/数学分析/MITmaths.md)** — 数学分析、复变函数、数理方程(征集中)
- **[代数](代数/线性代数/MITLA.md)** — 线性代数、高等代数、矩阵分析、抽象代数
...
- **[专题](专题/信息论/The_Information_Theory_Pattern_Recognition_and_Neural_Networks.md)** — 信息论、密码学
...
课程分三条线。分析线从数学分析延伸出复变函数、数值分析、概率统计，概率统计再支撑信息论。代数线从线性代数延伸出矩阵分析和高等代数，高等代数经抽象代数通向密码学。凸优化同时依赖数学分析和线性代数。离散数学不依赖分析与代数，可以直接学。

## 学习路径建议

国内的"高等数学 + 线性代数"和"数学分析 + 高等代数"是两套体系，数学分析比高数严格但深。**IC 学生通学高数+线代即可**，数学分析适合想做理论研究的同学。微积分和线代强烈推荐 **MIT 18.01/18.02 + MIT 18.06(Gilbert Strang)**，YouTube 和 B 站全公开。

其余课程**按科研方向反推**，不必把所有数学都学一遍：

- 做 ML/AI：概率与统计 + 矩阵分析 + 凸优化
- 做模拟/射频：复变函数 + 信号处理基础
- 做 EDA：离散数学 + 凸优化 + 数值分析
