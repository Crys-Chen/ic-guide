...
如你所见，现在这份学习地图里面，以复旦的课程为主，而且很多课程仅对复旦校内开放。这主要是因为复旦的信息化建设不好，但这个仓库最开始肯定是由复旦的同学维护，所以为了更好服务复旦的同学而挂上来，作为一个评教和分享笔记的页面。期待后面有更多学校的同学加入分享。

注：请各位同学尊重老师的知识产权，如若老师没有主动分享课程资源到公网，那大家在分享前请先征得老师同意。至于往年试题......还是私下流传吧。

目前学习地图中还有以下课程存在缺漏，欢迎大家积极补充，通过[参与建设](../参与建设.md)推荐你验证过的好课。
