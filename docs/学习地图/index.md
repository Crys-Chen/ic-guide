...
学习地图按知识领域分为七个板块，每个板块收录经过核实的公开课程。[科研方向](../科研方向/)页面说明做某个研究方向需要哪些知识，这里给出每个知识领域的具体学习路径。
...
| [电路](电路/index.md) | 数字、模拟、信号处理三条路线，从逻辑门到射频集成电路 |
...
图中有两条主干链：物理→器件与工艺→电路，是器件和模拟方向的纵向路径；算法编程→系统架构→人工智能，是数字和AI方向的纵向路径。数学横向支撑电路和人工智能两个板块。
