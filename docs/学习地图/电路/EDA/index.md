...
- **复旦 2025 培养方案课程**:[VLSI物理设计数学方法](FDU_ICSE30026.md)；占位骨架（欢迎补全）:[数字EDA基础](FDU_ICSE30019.md) · [模拟EDA基础](FDU_ICSE30018.md) · [EDA系统软件方法学](FDU_ICSE30028.md)；AI for EDA 课程见[人工智能/AI交叉应用](../../人工智能/AI交叉应用/FDU_ICSE40019.md)
