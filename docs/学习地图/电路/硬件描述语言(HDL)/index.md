...
- **HLS（高层次综合）** — 把 C/C++ 直接综合成 RTL;见导航栏 HLS 分组

## 学习路径建议

**Verilog 是绕不开的起点**。HDLBits 在线刷题(像 LeetCode 的 Verilog 版)是最快入门的方式;Nandland 的图文教程适合零基础;UCB EECS151/251A 是含 RISC-V Project 的完整数字设计课。
