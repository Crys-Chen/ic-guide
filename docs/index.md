...
3. 信息极度闭塞：微电子圈没有计算机圈那种浓厚的开源与分享氛围，网络上的干货信息极其匮乏。整个学术圈对本科生来说就像一座密不透风的堡垒，大家始终是门外汉，连门朝哪开都不知道。
...
如今我本科即将毕业，我将这些笔记系统整理后放在了网站的「科研方向」板块中，尽力勾勒出一个较为完整的学术谱系，希望能帮大家拨开迷雾。如果屏幕前的你还是一名科研小白，强烈建议直接阅读巡礼这一篇。它对这 17 个科研方向做了提纲挈领式的综述。找到感兴趣的方向后，再点击进入细分页面，你就能看到该方向的具体研究内容、是否与你契合，以及目前有哪些对口的课题组和企业。
...
本科时的我是个“学术吕布”，没在哪个方向深耕，而是在好几个课题组之间流转打杂，深一脚浅一脚地做过不少项目、上过不少网课、摸过不少方向。但对正常求学的同学来说，自当是“弱水三千，只取一瓢”，完全不必把这里的内容全吃透，更不必像我一样到处乱趟。

想要高效使用本站，其实很简单，把「科研方向」与「学习地图」配合着看就行。不知道未来干嘛、准备找课题组的同学，可以先去「科研方向」里摸清大盘，选中心水的方向后，再按图索骥去「学习地图」里学习对应的前置知识；相反，如果是正深陷培养方案泥潭的低年级同学，可以先看看「学习地图」，学到哪个硬核知识点觉得有点意思，再顺藤摸瓜去「科研方向」里看看它未来到底能用来造什么系统、发什么 paper。

简单来说，一个帮你仰望星空定目标，一个帮你脚踏实地补基础。

我当年做科研时，没有这样一份地图，只能自己一个方向一个方向去盲目试错。希望现在这个网站可以让大家不必再走我的弯路。
...
在我眼里，程序员一直是个很伟大的群体。在还没有 AI 的年代，他们本可以把技术攥在手里、自抬身价，但他们中很多人没有这样做，他们始终坚持开源共享。如今迎来了 AI 时代，他们中最顶尖的那批人做的第一件事，反倒是毫不留情地亲手革自己的命，把赖以谋生的饭碗一件件教给 AI 去做。我之所以决定做出这个网站，正是深受这种极客与开源精神的深深感召。
...
所以，如果你恰好在这个浩瀚学科的某个角落里深耕，如果你也认同这份开源的诚意，欢迎点击导航栏的「参与建设」，查看当前网页的空缺。
