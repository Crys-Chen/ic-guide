...
复旦微电的同学应该都有同感，就是培养方案里很多课其实是"假课"，现实中根本没有开设，或者隔几个学期才开一次。比如我本科四年就一直想选修《存储器电路设计导论》，但这门课两年才开一次，开的时候又跟我必修课时间撞上了，完全没机会修读。这种“阴阳课表”导致我们每学期能选的课其实就那么几门，所有人上的课都大差不差，并不存在按自己需要 DIY 课表的理想情况。此外，不同课由不同教授开，学院很难把这些主业科研的老师聚到一起，坐下来商量课程之间怎么衔接。所以不同课程之间要么叠床架屋，要么彼此之间隔着巨大的 gap 要学生自学。在复旦微电上课，有点像刷短视频，一会上这个，一会上那个，一会又把同样的东西刷一遍，效率低，体验也不好。

还有一件事。我本科这几年，几乎每年的培养方案都不一样。21 级和 22 级大体相同，到 23、24 就变了很多。如今再看 2025 级的方案，里面已经有不少我不认识的课程。把 21 和 25 两份逐课比过，变化其实很清楚。选修课从过去按传统学科零碎切块的几个课程池，重组成了新算力、新制造、芯粒集成三个对接产业前沿的模块；课程总数从七十来门增到九十多门，大幅增设；最显眼的是 AI 成建制地进了课表，21 级几乎没有一门独立的 AI 课，25 级一口气加了十来门，从人工智能导论一直排到 AI 专用芯片设计、AI 算法在 EDA 的应用。一句话，从零碎拼凑转向了以前沿方向的需求为导向，方向和本网站的初衷完全一致。而作为地基的核心必修课一门没动，知识的连续性是保住的。完整的逐课对比我写在了[从微电子到集成电路：培养方案课改解读](学习地图/复旦培养方案课改解读.md)里。受肉身局限，我没法再把新方案重新读一遍，所以本网站主要是为 21、22 级的培养方案打的补丁。但知识连续这件事不分版本，补丁照样能用。

学校和学院的出发点是好的，就是不知道他们到底出发了没有。但改革总是文件先行嘛，可以理解。相信领导们之后会修复这个 bug。
