...
对本科生来说，做科研最大的困境其实不是知识不够，而是信息不透明。
...
这个网站所能做的，就是在这个堡垒的墙上稍微凿开一个口子。微电子相关的科研方向，我自己梳理了一下，大概有 17 个。这几年东一榔头西一棒槌做下来，总算有了点系统的认知。比起教学相长，我更喜欢用写作来巩固自己的认知，所以积累了很多笔记。如今即将毕业，我将笔记整理好放在这个网站的「科研方向」里，尽力梳理出一个较为完整的学术谱系，希望对大家了解这门学科有所帮助。如果屏幕前的你还是一位小白，那可以直接阅读[巡礼](科研方向/巡礼.md)这一篇，它对 17 个科研方向做了提纲挈领式的综述，然后你对哪个方向感兴趣，就直接点进去细分的方向页，可以看到这个方向具体在研究什么、是否适合你，有哪些课题组和对口企业。
...
在我眼里，程序员是一个很伟大的群体。在还没有 AI 的年代，他们本可以把技术攥在手里、抬高门槛，却始终坚持开源共享。如今有了 AI，他们中最厉害的那批人做的第一件事，反倒是亲手革自己的命，把赖以谋生的活儿一件件交给 AI。我做出这个网站，正是受到了这种开源精神的感召。说句实话，没有 Vibe Coding，这样的网站我两年也做不出来。
