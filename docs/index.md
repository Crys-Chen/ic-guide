...
本仓库继承自北京大学的 [CS 自学指南](https://github.com/pkuflyingpig/cs-self-learning/)，可以说是它的硬件孪生版。CS 自学指南帮人自学计算机，这一份就帮人自学集成电路（IC, Integrated Circuits），名字也就顺理成章叫了"IC 自学指南"。原仓库关于 CS 的资源我基本保留了下来，没有删，这不是凑数。集成电路和计算机本就同根，做架构、做系统研究的 CS 同学，没有硬件知识同样寸步难行。所以这个网站虽以 IC 为主，也一样欢迎想补硬件的 CS 同学，欢迎大家一起参与贡献。
