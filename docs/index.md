...
微电子科学与工程（Microelectronics, ME），或称集成电路（Integrated Circuits, IC），是一门理工结合、多学科交叉的专业，它横跨材料、物理、化学、计算机等多个领域，是工科里难度系数最高的专业之一。在大多数欧美高校，它从来不是一个独立的系或专业，只是电子工程（EE）或电子与计算机工程（ECE）底下的一个分支。而近十年，内地高校为响应国家号召，相继把它立成一级学科，向本科生敞开。
