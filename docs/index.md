...
还有一件事。我本科这几年，几乎每年的培养方案都不一样。21 级和 22 级大体相同，到 23、24 就变了很多。如今再看 2025 级的方案，里面已经有不少我不认识的课程。我把 21 和 25 两份逐课比过，变化一目了然。

|  | 2021 级 | 2025 级 |
|---|---|---|
| 选修怎么组织 | 按传统学科零碎切块 | 按前沿方向立模块（新算力 · 新制造 · 芯粒集成） |
| 课程总数 | 70 余门 | 90 余门 |
| AI 相关课 | 几乎没有 | 成建制十余门 |
| 核心必修主干 | 同一批，未动 | 同一批，未动 |

一句话，从零碎拼凑转向了以前沿方向的需求为导向，方向和本网站的初衷完全一致。而作为地基的核心必修一门没动，知识的连续性是保住的。完整的逐课对比，我写在了[从微电子到集成电路：培养方案课改解读](学习地图/复旦培养方案课改解读.md)里。受肉身局限，我没法再把新方案重新读一遍，所以本网站主要是为 21、22 级的培养方案打的补丁。但知识连续这件事不分版本，补丁照样能用。
