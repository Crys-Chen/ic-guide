...
面对这样快速迭代的学科，体制内的培养方案永远是后知后觉的。与其被动地等待，不如主动出击，上网寻找优质网课，把 AI 当作自己的专属助教。尽管内地几百所高校或许凑不出一门令人满意的线性代数，但 MIT 早就将 [Gilbert Strang 教授的经典神课](学习地图/数学/代数/线性代数/MITLA.md)公之于众；尽管集成电路的开源论坛远不如计算机领域活跃，但如今有了 AI 的加持，什么傻瓜问题都能得到耐心的解答。
