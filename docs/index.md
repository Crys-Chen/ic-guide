...
再说自顶向下。前沿方向到底在干嘛，光看课表是看不出来的。对本科生来说，做科研最大的困境其实不是知识不够，而是信息不透明。

刚入学时，一位学长对我说："微电子，本科打基础，硕士算入门，博士顶多叫略懂。"这个专业本科毕业的工作机会很少，很多人硕士起步。所以早点想清楚自己适不适合做科研、对哪个方向有兴趣，就格外重要。现在不少同学本科就提前进实验室，这是好事。可要做这个判断，你得先看清楚有哪些方向、每个方向在干嘛，而这恰恰是本科生最难拿到的信息。

难就难在三处。一是这门学科本身太艰深，刚入门就一头扎进某个细分方向，很容易“只见树木，不见森林”，连自己做的事在整张图里处于什么位置都说不清。二是课题组不一定会认真带，带你的学长姐自己未必清楚在干嘛，老师也未必愿意花时间把一个本科生真正领进门。三是网上几乎找不到现成的信息，微电子不像计算机有那么浓厚的开源社区和分享氛围，整个学术圈对本科生来说就像一座密不透风的堡垒，你一直身处局外，连门在哪都不知道。

我能做的，是把这堵墙凿开一个口子。微电子相关的科研方向，我自己梳理了一下，一共 17 个。过去几年广泛的探索与阅读里，我或门外汉、或局内人地，建立起对这 17 个方向的初步了解，有了一个较为全局的视角。比起教学相长，我更喜欢用写作来梳理自己的认知。临近毕业，总算有空用 vibe coding 把零零碎碎的笔记一次分享出来。我个人觉得其中最精华的，当属[巡礼](科研方向/巡礼.md)这一篇，它对 17 个科研方向做了提纲挈领式的综述。想了解某个细分领域的同学，也可以直接点开它的页面，看看这个方向在研究什么、适合什么样的同学，有哪些课题组和对口企业。哪怕只是帮你在扎进某个方向之前先看清这片森林的轮廓，也不算白写。
