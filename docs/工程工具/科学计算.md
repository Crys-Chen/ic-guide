...
ECE/EE 学生在信号处理、控制系统、数据分析、仿真等场景中都需要科学计算工具。MATLAB 是行业标准，Python 是免费且更通用的替代。两者都要会用。
...
- 复旦学习地图：见 [MATLAB(复旦)](../学习地图/电路/信号处理/MATLAB/MICR130022.md)
...
!!! tip "实用建议"
    先学 MATLAB 把课过了，然后把同样的代码用 Python 复现一遍——这是理解两者差异最快的路径。
